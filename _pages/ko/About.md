...
...라고 생각했습니다만, 이건 제가 블로그 운영을 시작한 2021년 정도의 이야기이고, 어느새 AI가 발전하여 많은 일을 시킬 수 있게 되었습니다. 여전히 수학 문서를 처음부터 쓰게 하기에는 부족하지만, 이미 있는 파일을 번역하는 것 정도는 믿고 맡길 수 있는 정도가 되었고 이로부터 다국어 사이트로 만드려는 오랜 위시리스트를 이룰 수 있게 되었습니다. 
