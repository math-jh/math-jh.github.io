...
[\[블로그 개발\] §다국어 지원](/ko/misc/blog_development/multilingual)에서 이미 이 사이트를 한글/영어를 병행하여 운영할 준비는 갖추어 두었습니다. 그러나 위에서 이야기한 것과 같이 새로 추가한 내용들이 원래의 문서 분량보다도 많아지는 현상이 일어나서, 기존의 $\TeX$ 문서를 마크다운 문법에 맞추어 복사-붙여넣기만 하면 될 것이라 생각했던 행복한 상상이 깨져버렸습니다. 
