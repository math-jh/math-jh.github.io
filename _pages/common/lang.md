...
<p style="font-size:min(4vh, 4vw); line-height:calc(min(14vh,14vw) - 4px); margin:0 0; padding: 0 0; border: 0"><a href="{{ site.url }}/ko" style="margin:0 0; padding: 0 0;">한글</a></p>
</div>
...
<p style="font-size:min(4vh, 4vw); line-height:calc(min(14vh,14vw) - 4px); margin:0 0; padding: 0 0; border: 0"><a href="{{ site.url }}/en" style="margin:0 0; padding: 0 0;">English</a></p>
</div>
