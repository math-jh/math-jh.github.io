...
\begin{tikzpicture}[line join=round, line cap=round]
  ...
  \draw (0,0) -- (2,0) -- (1.5,.5) -- cycle; 
  \draw (1.5,.5) -- (1.5,2);
  \draw[preaction={draw=white, line width=1.5pt}] (0,1.5) -- (2,1.5); 
  \fill[gray, opacity=.4] (0,1.5) -- (2,1.5) -- (1.5,2) -- cycle; 
  \draw (0,0) -- (0,1.5);
  \draw (2,0) -- (2,1.5);
  \draw (0,1.5) --(1.5,2)--(2,1.5);
  \draw[|-|] (3,0) --(3,1.5);
  \draw (3,.75) node[right]{$I$};
  \draw (3.1,0) node[right, scale=.5]{$t=0$};
  \draw (3.1,1.5) node[right, scale=.5]{$t=1$};
  \draw (0,0) node[below left, scale=.6]{$v_0$};
  \draw (2,0) node[below right, scale=.6]{$v_1$};
  \draw (1.5,.6) node[left, scale=.6]{$v_2$};
