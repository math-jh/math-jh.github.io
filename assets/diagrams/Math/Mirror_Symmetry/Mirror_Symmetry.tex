...
%% def12: Gr(2,4) plabic graph(square) + face labels (Postnikov_Diagram_and_Plabic_Graph-6.png)
...
%% def10: Gr(2,4) Postnikov diagram, i->i+2, over/under (white gaps -> post-process transparent) (Postnikov_Diagram_and_Plabic_Graph-5.png)
\begin{tikzpicture}[scale=1.3, >=Stealth,
   strand/.style={line width=1.5pt, postaction={decorate,
      decoration={markings, mark=at position 0.5 with {\arrow{Stealth[length=3mm]}}}}},
   bare/.style={line width=1.5pt}]
