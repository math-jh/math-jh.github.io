...
%% 예시11 첫째 계산 후보: Gr(2,5) σ_3⋆σ_2 classical 후보 (5),(4,1),(3,2); λ=(2) 회색 + horizontal 3-strip 빨강, 점선 2x3, (3,2)만 초록 (현재 Quantum_Pieri_Rule-7.png로 staging; 문서순서상 최종 -4 예정, rotation 시 -4)
...
%% 예시11 후보: Gr(2,5) σ_2⋆σ_(2,1) classical 후보 (4,1),(3,1,1),(2,2,1),(3,2); (2,1) 회색 + strip 빨강, 점선 2x3, (3,2)만 초록 (Quantum_Pieri_Rule-4.png)
\begin{tikzpicture}[scale=0.5]
...
%% 예시11 결과: Gr(2,5) σ_2⋆σ_(2,1)=σ_(3,2)+q; λ=(2,1) 회색 + horizontal 2-strip 빨강, 초과분이 q (Quantum_Pieri_Rule-5.png)
...
%% rim hook: Gr(2,4)에서 직사각형(2x2) 밖 (3,1)의 4-rim hook 제거 → ∅, +q (Quantum_Pieri_Rule-6.png)
\begin{tikzpicture}[scale=0.5]
  \begin{scope}[shift={(0,0)}]
