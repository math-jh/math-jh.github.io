...
<ins id="ex3">**예시 3**</ins> $\id_M:M\rightarrow M$은 당연하게 $C^\infty$ 함수이다. 더 일반적으로, 임의의 열린집합 $U\subseteq M$에 open submanifold 구조를 주면 ([§미분다양체의 예시들, 정의 3](/ko/math/manifold/examples#df3)) inclusion map $U\hookrightarrow M$은 $C^\infty$ 함수이다. 
