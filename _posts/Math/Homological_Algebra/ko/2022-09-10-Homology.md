...
![chain_map](/assets/images/Homological_Algebra/Homology-1.png){:width="475.95px" class="invert" .align-center}
...
![kernel_of_chain_map](/assets/images/Homological_Algebra/Homology-2.png){:width="217.2px" class="invert" .align-center}
...
![universal_property_of_kernel_in_Ch_category](/assets/images/Homological_Algebra/Homology-3.png){:width="274.35px" class="invert" .align-center}

을 보여야 한다. ([\[범주론\] §아벨 카테고리, ⁋정의 3](/ko/math/category_theory/abelian_categories#df3)) 이를 위해서는 우선 각각의 $n$에 대하여 다음 diagram

![degreewise_universal_property](/assets/images/Homological_Algebra/Homology-4.png){:width="279.75px" class="invert" .align-center}

을 통해 $j\_n:A\_n\rightarrow \ker f\_n$을 만든 후, $j_\bullet$이 chain map임을 보이면 충분하다. 즉, 다음 diagram

![monomorphism_trick](/assets/images/Homological_Algebra/Homology-5.png){:width="217.2px" class="invert" .align-center}
...
![differential_endomorphism](/assets/images/Homological_Algebra/Homology-6.png){:width="650.1px" class="invert" .align-center}

와 같이 정의하자. 그럼 $\ker (d_\bullet)$이 잘 정의되며, 다음의 diagram

![differential_of_Z](/assets/images/Homological_Algebra/Homology-7.png){:width="244.2px" class="invert" .align-center}
...
![differential_of_H](/assets/images/Homological_Algebra/Homology-8.png){:width="496.8px" class="invert" .align-center}
...
![double_complex](/assets/images/Homological_algebra/Homology-9.png){:width="568.8px" class="invert" .align-center}
