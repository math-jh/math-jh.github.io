...
<ins id="def2">**정의 2**</ins> 임의의 chain complex
...
<ins id="prop3">**명제 3**</ins> 임의의 $$n$$에 대하여, $$H_n$$은 $$\Ch(\mathcal{A})$$에서 $$\mathcal{A}$$로의 functor이다.
...
<ins id="def4">**정의 4**</ins> Abelian category $$\mathcal{A}$$의 대상들로 이루어진 *double complex*는 다음의 두 함수들
...
<ins id="def5">**정의 5**</ins> Double complex $$C_{p,q}$$의 *total complex* $$\Tot(C)_\bullet$$는 각 차수 $$n$$에서
