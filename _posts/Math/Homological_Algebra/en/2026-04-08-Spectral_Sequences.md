...
As mentioned above, the following [Definition 2](#def2){: data-lid="4s5zq" data-relation="required" } is a much more general version, but the philosophy of decomposing a complex more finely remains essentially the same.
...
::: Proposition 7
The $E_r^{p,q}$ and $d_r$ constructed from a filtered complex $(A^\bullet, F)$ as above satisfy the conditions of a spectral sequence in [Definition 1](#def1){: data-lid="4ju1l" data-relation="required" }. Namely,
...
That is, fixing [Definition 2](#def2){: data-lid="pviw6" data-relation="required" } in degree $n$ and considering the filtration
...
::: Proposition 10
Let $(A^\bullet, F)$ be a bounded filtered complex, and let $(E_r^{p,q})$ be the spectral sequence it defines. Then $(E_r^{p,q})$ converges to the filtered graded object $(H^\bullet, F)$ of [Definition 3](#def3){: data-lid="1nm6o" data-relation="required" }. That is, $E_r^{p,q}\Rightarrow H^{p+q}(A^\bullet)$.
:::
