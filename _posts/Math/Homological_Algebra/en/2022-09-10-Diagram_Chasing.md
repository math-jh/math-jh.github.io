...
---
Homological algebra is, literally, the study of the properties of chain complexes via their homology. ([\[Category Theory\] §Abelian Categories, ⁋Definition 4](/en/math/category_theory/abelian_categories#def4){: data-lid="yy10y" data-relation="weak" }) Chain complexes are defined in any abelian category, but by the Freyd-Mitchell embedding theorem they can all be embedded as a full subcategory of some $\lMod{A}$. ([\[Category Theory\] §Abelian Categories, ⁋Theorem 8 (Freyd-Mitchell embedding theorem)](/en/math/category_theory/abelian_categories#thm8){: data-lid="0tnor" data-relation="required" })
...
{% diagram Math/Homological_Algebra/Diagram_Chasing-1.svg width="15.54em" alt="Four_lemma" %}
...
{% diagram Math/Homological_Algebra/Diagram_Chasing-2.svg width="20.26em" alt="five_lemma" %}
...
{% diagram Math/Homological_Algebra/Diagram_Chasing-3.svg width="18.88em" alt="short_five_lemma" %}
...
{% diagram Math/Homological_Algebra/Diagram_Chasing-4.svg width="6.22em" alt="induced_morphism" %}
...
{% diagram Math/Homological_Algebra/Diagram_Chasing-5.svg width="13.20em" alt="induced_morphism_kernel" %}
...
{% diagram Math/Homological_Algebra/Diagram_Chasing-7.svg width="10.84em" alt="induced_exact_sequence" %}
...
is a consequence of [Lemma 4](#lem4){: data-lid="yt1hi" data-relation="required" }. Moreover, letting $i_A, i_B, i_C$ be the canonical maps from the kernels to $A,B,C$ respectively,
...
Here the top and bottom rows are each exact. Then there exists a map $\delta:\ker(\gamma)\rightarrow\coker(\alpha)$ connecting the two exact sequences obtained from [Lemma 5](#lem5){: data-lid="ug6c6" data-relation="required" }
...
{% diagram Math/Homological_Algebra/Diagram_Chasing-10.svg width="19.30em" alt="Nine_lemma" %}
