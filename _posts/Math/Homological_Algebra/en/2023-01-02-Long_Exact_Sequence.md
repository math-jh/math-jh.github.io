...
::: Definition 4
Two chain complexes $$C_\bullet$$, $$D_\bullet$$ are *quasi-isomorphic* if $$H_n(C)\cong H_n(D)$$ for all $$n$$. If a chain map $$f:C\rightarrow D$$ is such that $$H_n(f)$$ is an isomorphism for every $$n$$, we call $$f$$ a *quasi-isomorphism*.[^1]
:::
...
::: Definition 5
Let two chain complexes $$C,D$$ and chain maps $$f,g:C\rightarrow D$$ be given. Then a *chain homotopy* between $$f$$ and $$g$$ is a collection of maps $$h_n:C_n\rightarrow D_{n+1}$$ in the following diagram
...
::: Proposition 6
Two homotopic chain maps $$f,g:C\rightarrow D$$ induce the same map on homology.
:::
::: Proof
...
::: Corollary 9
A chain map $$f: C_\bullet \rightarrow D_\bullet$$ is a quasi-isomorphism if and only if $$\cone(f)$$ is exact. 
:::
