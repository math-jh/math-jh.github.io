...
:::
::: Proof
For an arbitrary chain map $f_\bullet:C_\bullet\rightarrow D_\bullet$, applying [§Diagram chasing, ⁋Lemma 4](/en/math/homological_algebra/diagram_chasing#lem4){: data-relation="required" } shows that $f_n$ induces $Z_n(C)\rightarrow Z_n(D)$ and $B_n(C)\rightarrow B_n(D)$. Therefore $f_n$ induces
