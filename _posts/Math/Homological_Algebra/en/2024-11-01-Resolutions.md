...
::: Definition 2
Let $$M$$ be an object of an abelian category $$\mathcal{A}$$.
...
::: Proposition 3
If an abelian category $$\mathcal{A}$$ has enough projectives, then every object $$M$$ in $$\mathcal{A}$$ has a projective resolution. Likewise, if an abelian category $$\mathcal{A}$$ has enough injectives, then every object $$M$$ in $$\mathcal{A}$$ has an injective resolution.
:::
::: Proof
...
::: Theorem 6
Let a projective resolution $$P_\bullet \rightarrow M$$ and any $$u:M \rightarrow N$$ be given. Then for every left resolution $$Q_\bullet \rightarrow N$$, there exists a chain map $$f:P_\bullet \rightarrow Q_\bullet$$ making the following diagram
...
::: Lemma 7
Let the following short exact sequence
