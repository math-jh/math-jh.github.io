...
<ins id="def3">**정의 3**</ins> 위상공간 $$X$$가 주어졌다 하고, $$X$$의 부분집합들의 family $$(A_i)_{i\in I}$$가 주어졌다 하자. 그럼 $$(A_i)$$가 *locally finite<sub>국소적으로 유한</sub>*이라는 것은 임의의 $$x\in X$$마다, 적당한 근방 $$V$$가 존재하여 $$V\cap A_i\neq\emptyset$$을 만족하는 $$i$$가 오직 유한 개 뿐인 것이다.
...
<ins id="prop4">**명제 4**</ins> 위상공간 $$X$$가 주어졌다 하자. 만일 $$(A_i)_{i\in I}$$가 locally finite인 닫힌집합들의 모임이라면, $$A=\bigcup A_i$$는 닫힌집합이다.
