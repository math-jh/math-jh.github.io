...
<ins id="prop2">**명제 2**</ins> 위상공간 $$X$$와 그 위에 정의된 sheaf $$\mathcal{F}$$, 그리고 $$X$$의 임의의 열린집합 $$U$$에 대하여 다음의 함수
...
<ins id="def3">**정의 3**</ins> 위상공간 $$X$$와 그 위에 정의된 sheaf $$\mathcal{F}$$, 그리고 $$X$$의 임의의 열린집합 $$U$$에 대하여, 집합 $$\prod_{x\in U} \mathcal{F}_x$$의 원소 $$(s_x)_{x\in U}$$가 *compatible*한 germ들로 이루어져 있다는 것은 각각의 $$x\in U$$마다 적당한 열린근방 $$V_x\subseteq U$$가 존재하여, $$s_x=[(\tilde{s}_x, V_x)]$$라 하였을 때 다음 식
...
<ins id="prop4">**명제 4**</ins> $$X$$ 위에 정의된 sheaf들 사이의 morphism $$\phi:\mathcal{F}\rightarrow \mathcal{G}$$이 주어졌다 하자. 그럼 $$\phi$$가 isomorphism인 것과 stalk들 사이의 morphism $$\phi_x:\mathcal{F}_x \rightarrow \mathcal{G}_x$$가 모두 isomorphism인 것이 동치이다.
...
<ins id="def7">**정의 7**</ins> $$X$$ 위에 정의된 sheaf $$\mathcal{F}$$, 그리고 sheaf morphism $$\phi:\mathcal{F}\rightarrow \mathcal{G}$$가 주어졌다 하자. 
...
<ins id="prop8">**명제 8**</ins> 임의의 위상공간 $$X$$와 그의 base $$\mathcal{B}$$가 주어졌다 하고, 각각의 $$B\in \mathcal{B}$$마다 $$\mathcal{F}(B)$$ 그리고 $$B_i,B_j\in \mathcal{B}$$가 $$B_i\subseteq B_j$$를 만족할 때마다 정의된 restriction map들
...
<ins id="ex14">**예시 14**</ins> 예시 13에서는 한 점에 대한 inclusion $$i_y:\{y\}\rightarrow Y$$를 다루었다. 이와 유사하게 open embedding $$j:U\hookrightarrow X$$에 대하여 *extension by zero*라 불리는 sheaf functor $$j_!$$를 정의할 수 있다. $$U$$ 위에 정의된 sheaf $$\mathcal{F}$$에 대하여, presheaf
...
<ins id="prop15">**명제 15**</ins> 위상공간 $$X$$ 위에 정의된 sheaf morphism $$\phi: \mathcal{F}\rightarrow \mathcal{G}$$가 주어졌다 하자. 그럼 다음이 동치이다.
...
<ins id="prop16">**명제 16**</ins> 위상공간 $$X$$ 위에 정의된 sheaf morphism $$\phi: \mathcal{F}\rightarrow \mathcal{G}$$가 주어졌다 하자. 그럼 다음이 모두 동치이다.
