...
1. (Identity axiom) 임의의 $$B\in \mathcal{B}$$와 open covering $$\{B_i\in \mathcal{B}\}_{i\in I}$$에 대하여, 만일 $$s,t\in\mathscr{F}(B)$$가 모든 $$i\in I$$에 대해 $$s\vert_{B_i}=t\vert_{B_i}$$를 만족한다면 $$f=g$$이다.
