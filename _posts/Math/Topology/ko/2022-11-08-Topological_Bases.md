...
<ins id="def1">**정의 1**</ins> 위상공간 $$(X,\mathcal{T})$$에 대하여, $$\mathcal{T}$$의 부분집합 $$\mathcal{B}$$가 $$\mathcal{T}$$의 *base<sub>기저</sub>*라는 것은 임의의 $$U\in\mathcal{T}$$에 대하여, $$U=\bigcup_{i\in I} B_i$$를 만족하는 $$\mathcal{B}$$의 원소들의 family $$(B_i)_{i\in I}$$가 존재하는 것이다.
