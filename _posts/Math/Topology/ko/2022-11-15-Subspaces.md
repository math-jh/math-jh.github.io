...
<ins id="lem2">**보조정리 2**</ins> 위상공간 $$X$$의 부분공간 $$A$$에 대하여, $$A$$의 모든 닫힌집합이 $$X$$에서도 닫힌집합일 필요충분조건은 $$A$$가 $$X$$의 닫힌집합인 것이다.
...
<ins id="lem3">**보조정리 3**</ins> 위상공간 $$X$$의 부분공간 $$A$$와 임의의 $$x\in A$$에 대하여, 모든 $$A$$에서의 $$x$$의 근방이 $$X$$에서도 $$x$$의 근방일 필요충분조건은 $$A$$가 $$X$$에서 $$x$$의 근방인 것이다.
...
<ins id="prop4">**명제 4**</ins> 위상공간 $$X$$와 부분집합들 $$A\subseteq B\subseteq X$$를 생각하자. 그럼 $$B$$에 대한 $$A$$의 closure $$\cl_BA$$는 
...
<ins id="prop5">**명제 5**</ins> 위상공간 $$X$$와, $$X$$의 부분집합들 $$(A_i)_{i\in I}$$가 주어졌다 하고, 다음 두 조건 중 하나가 성립한다 하자.
...
<ins id="ex6">**예시 6**</ins> 두 위상공간 사이의 함수 $$f:X\rightarrow Y$$가 연속이 아니라 하자. 임의의 $$x\in X$$에 대하여, $$A=\{x\}$$으로 두면 $$f\vert_A$$는 연속이다. 이는 $$Y$$의 임의의 열린집합 $$U$$에 대하여, $$f^{-1}(U)$$는 항상 공집합 혹은 $$\{x\}$$이기 때문이다.
...
<ins id="prop7">**명제 7**</ins> 위상공간 $$X$$와, [명제 5](#prop5)의 조건 중 하나를 만족하는 부분집합들의 모임 $$(A_i)_{i\in I}$$가 주어졌다 하자. 그럼 위상공간 $$Y$$로의 임의의 함수 $$f:X\rightarrow Y$$가 연속인 것은 $$f\vert_{A_i}$$가 모두 연속인 것과 동치이다.
