...
For the same reason as in [§Properties of Product Sets, ⁋Proposition 3](/en/math/set_theory/property_of_products#prop3), taking products of spaces satisfies the associative law, and similarly there is a proposition for the commutative law. These are fairly obvious, so we do not state them separately.
