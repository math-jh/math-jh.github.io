...
Then by [§Initial and Final Topology, ⁋Proposition 2](/en/math/topology/initial_and_final_topology#prop2){: data-lid="jexxp" data-relation="required" }, the product topology on $X$ is the topology generated by the following collection as a subbase:
...
For the same reason as in [\[Set Theory\] §Properties of Products, ⁋Proposition 3](/en/math/set_theory/property_of_products#prop3){: data-lid="xnb41" data-relation="weak" }, taking products of spaces satisfies the associative law, and similarly there is a proposition for the commutative law. These are fairly obvious, so we do not state them separately.

On the other hand, applying [§Initial and Final Topology, ⁋Proposition 3](/en/math/topology/initial_and_final_topology#prop3){: data-lid="ckunt" data-relation="required" }, we obtain the following.
