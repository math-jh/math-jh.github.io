...
::: Definition 1
A function $f:X\rightarrow Y$ between topological spaces $X$, $Y$ is said to be *continuous* at $x\in X$ if for every neighborhood $V$ of $f(x)\in Y$, there exists a neighborhood $U$ of $x$ such that $f(U)\subseteq V$.
:::
...
:::
::: Proof
Choose any neighborhood $V$ of $f(x)\in Y$. Then $f^{-1}(V)$ is a neighborhood of $x$, so $f^{-1}(V)\cap A\neq\emptyset$ ([§Interior, Closure, and Boundary, ⁋Proposition 6](/en/math/topology/other_concepts#prop6){: data-lid="8n9ux" }). Taking $x'\in f^{-1}(V)\cap A$, we have $f(x')\in V\cap f(A)$. In particular, $V\cap f(A)\neq\emptyset$, so applying [§Interior, Closure, and Boundary, ⁋Proposition 6](/en/math/topology/other_concepts#prop6){: data-lid="gko4r" } again yields $f(x)\in\cl(f(A))$.
:::
...
:::
::: Proof
Choose any neighborhood $W$ of $(g\circ f)(x)$. Since $g$ is continuous at $f(x)$, the set $g^{-1}(W)$ is a neighborhood of $f(x)$. Since $f$ is continuous at $x$, the set $f^{-1}(g^{-1}(W))$ is a neighborhood of $x$. ([\[Set Theory\] §Operations on Binary Relations, ⁋Proposition 6](/en/math/set_theory/operation_of_binary_relations#prop6){: data-lid="kek67" })
:::
...
:::
::: Proof
That the first condition implies the second is a consequence of [Proposition 2](#prop2){: data-lid="ifvfg" }.
...
By [Proposition 3](#prop3){: data-lid="1cr1z" }, if two continuous functions $f:X\rightarrow Y$ and $g:Y\rightarrow Z$ are given, then $g\circ f$ is also continuous.
...
::: Example 5
In general, $f^{\mathcal{T}}$ need not be surjective. For instance, let $X_1$ be the space $\mathbb{N}$ with the discrete topology $\mathcal{T}_1$, and let $X_2$ be the space $\mathbb{N}$ with the trivial topology $\mathcal{T}_2$. Considering the identity map $\id:\mathbb{N}\rightarrow\mathbb{N}$ as a set map, $\id$ is a continuous bijection, but the function

$$\id^\mathcal{T}:\mathcal{T}_2\rightarrow\mathcal{T}_1$$

cannot be surjective. ([\[Set Theory\] §Operations on Cardinals, ⁋Proposition 10](/en/math/set_theory/operation_of_cardinals#prop10){: data-lid="kuoq3" })
:::
