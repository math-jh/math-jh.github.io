...
:::
::: Proof
Choose any neighborhood $W$ of $(g\circ f)(x)$. Since $g$ is continuous at $f(x)$, the set $g^{-1}(W)$ is a neighborhood of $f(x)$. Since $f$ is continuous at $x$, the set $f^{-1}(g^{-1}(W))$ is a neighborhood of $x$. ([\[Set Theory\] §Operations on Binary Relations, ⁋Proposition 6](/en/math/set_theory/operation_of_binary_relations#prop6){: data-lid="kek67" data-relation="required" })
:::
...
:::
::: Proof
That the first condition implies the second is a consequence of [Proposition 2](#prop2){: data-lid="ifvfg" data-relation="required" }.
...
By [Proposition 3](#prop3){: data-lid="1cr1z" data-relation="required" }, if two continuous functions $f:X\rightarrow Y$ and $g:Y\rightarrow Z$ are given, then $g\circ f$ is also continuous.
...
cannot be surjective. ([\[Set Theory\] §Operations on Cardinals, ⁋Proposition 10](/en/math/set_theory/operation_of_cardinals#prop10){: data-lid="kuoq3" data-relation="required" })
:::
