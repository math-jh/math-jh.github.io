...
For the second property, let $V_1,\ldots, V_n\in\mathcal{N}(x)$ be given. Then there exist open neighborhoods $U_1,\ldots, U_n$ of $x$ with $x\in U_i\subseteq V_i$. By the third condition of [Definition 1](#def1){: data-relation="required" }, their finite intersection $U_1\cap\cdots\cap U_n$ is also open, and therefore
