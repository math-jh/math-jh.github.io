...
::: Definition 3
Let two topologies $$\mathcal{T}_1$$ and $$\mathcal{T}_2$$ on a set be comparable under $$\subset$$. If $$\mathcal{T}_1\subset\mathcal{T}_2$$, then $$\mathcal{T}_2$$ is called a *stronger topology* than $$\mathcal{T}_1$$, and $$\mathcal{T}_1$$ is called a *weaker topology* than $$\mathcal{T}_2$$. 
:::
