...
::: Definition 1
A *topology* on a set $X$ is a subset $\mathcal{T}$ of $\mathcal{P}(X)$ satisfying the following conditions.
...
Adopting the convention from [\[Set Theory\] §Union and Intersection](/en/math/set_theory/union_and_intersection){: data-lid="7494p" data-relation="weak" }, one can show that the two sets
...
::: Example 2
For any set $X$, the smallest topology on $X$ is $\{\emptyset,X\}$. One readily checks that this family satisfies conditions 1–3, so it yields a topological space. It is called the *trivial topology*. 
...
::: Definition 3
Let two topologies $\mathcal{T}_1$ and $\mathcal{T}_2$ on a set be comparable under $\subseteq$. If $\mathcal{T}_1\subseteq\mathcal{T}_2$, then $\mathcal{T}_2$ is called a *stronger topology* than $\mathcal{T}_1$, and $\mathcal{T}_1$ is called a *weaker topology* than $\mathcal{T}_2$. 
:::
...
::: Definition 4
Let $X$ be a topological space and let $A$ be an arbitrary subset of $X$. Any open set containing $A$ is called an *open neighborhood* of $A$. A subset $S$ of $X$ is called a *neighborhood* of $A$ if there exists an open neighborhood $U$ of $A$ such that $U\subseteq S$.
:::
...
:::
::: Proof
By [Definition 4](#def4){: data-lid="j25lo" data-relation="required" }, the latter condition is equivalent to:
...
::: Proposition 6
Let $X$ be a topological space. Then $\mathcal{N}(x)$ satisfies the following properties.
...
For the second property, let $V_1,\ldots, V_n\in\mathcal{N}(x)$ be given. Then there exist open neighborhoods $U_1,\ldots, U_n$ of $x$ with $x\in U_i\subseteq V_i$. By the third condition of [Definition 1](#def1){: data-lid="lufpt" data-relation="required" }, their finite intersection $U_1\cap\cdots\cap U_n$ is also open, and therefore
