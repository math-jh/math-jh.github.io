...
---
In [§Continuous Functions](/en/math/topology/continuous_functions){: data-lid="z7rab" data-relation="required" } we defined, for a continuous function $f:X \rightarrow Y$, the function $f^\mathcal{T}:\mathcal{T}_Y\rightarrow\mathcal{T}_X$ by the formula
...
::: Proposition 2
The initial topology of [Definition 1](#def1){: data-lid="vmp2g" data-relation="required" } is exactly the topology generated by taking the set
...
::: Proposition 3
In the situation of [Definition 1](#def1){: data-lid="2oq1d" data-relation="required" }, suppose additionally that a topological space $Z$ and a map $g:Z\rightarrow X$ are given. Then $g$ is continuous if and only if each $f_i\circ g$ is continuous.
:::
::: Proof
...
Suppose each function $f_i\circ g$ is continuous. For an arbitrary proper open subset $U$ of $X$, by [Proposition 2](#prop2){: data-lid="jb8nc" data-relation="required" } there exist $U_j$ such that
...
::: Proposition 5
The topology of [Definition 4](#def4){: data-lid="or8n8" data-relation="required" } is defined by the set

$$\mathcal{T}_\fin=\{U\subseteq X\mid f^{-1}_i(U)\text{ is open in $Y_i$ for all $i$}\}$$
:::
::: Proof
That the given set $\mathcal{T}_\fin$ is actually a topology is easily verified. Thus it suffices to show that $\mathcal{T}_\fin$ satisfies all the conditions of [Definition 4](#def4){: data-lid="tpw0n" data-relation="required" }.
...
::: Proposition 6
In the situation of [Definition 4](#def4){: data-lid="w03d2" data-relation="required" }, suppose additionally that a topological space $Z$ and a map $g:X\rightarrow Z$ are given. Then $g$ is continuous if and only if each $g\circ f_i$ is continuous.
:::
::: Proof
...
are each open in $Y_i$. But by [Proposition 5](#prop5){: data-lid="hyckx" data-relation="required" }, this is equivalent to saying that $g^{-1}(U)$ is an open set in $X$, and therefore $g$ is continuous.
:::
