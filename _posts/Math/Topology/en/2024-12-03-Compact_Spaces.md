...
By the proposition above, to prove that $Y$ is compact it suffices to cover $Y$ by open sets in the ambient space $X$ and then show that these satisfy the condition of [Definition 1](#def1){: data-lid="8ix8i" data-relation="required" }. Therefore, by a slight abuse of terminology, we call open sets $U_i$ in $X$ satisfying $Y\subseteq \bigcup U_i$ an open cover of $Y$, and we shall make this distinction explicit only when there is a risk of confusion.
...
As mentioned above, a compact Hausdorff space satisfies the following additional separation axiom. ([§Hausdorff Spaces, ⁋Definition 3](/en/math/topology/Hausdorff_spaces#def3){: data-lid="unkff" data-relation="required" })
...
:::
::: Proof
To show this, we must prove that $f^{-1}$ is continuous. We use the third condition of [§Continuous Functions, ⁋Theorem 4](/en/math/topology/continuous_functions#thm4){: data-lid="44eko" data-relation="required" }: namely, we show that $f$ is a closed map. Given a closed subset $A$ of $X$, this follows by applying [Lemma 3](#lem3){: data-lid="m5ssk" data-relation="required" }, [Proposition 8](#prop8){: data-lid="sdibz" data-relation="required" }, and [Corollary 5](#cor5){: data-lid="d5sv9" data-relation="required" } in order.
:::
