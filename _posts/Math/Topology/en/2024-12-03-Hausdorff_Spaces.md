...
One of the notions of particular importance in [Definition 3](#def3){: data-lid="sjled" } is that of a Hausdorff space. Here our intuition is well-founded.
...
in $X^I=\prod_{i\in I}X$ is closed. From [Lemma 5](#lem5){: data-lid="tqzuv" } we obtain the following.
...
:::
::: Proof
Apply [Corollary 6](#cor6){: data-lid="9tl6q" } to the two continuous functions
