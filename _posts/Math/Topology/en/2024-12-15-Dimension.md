...
::: Definition 1
A family $(U_i)_{i\in I}$ of subsets of $X$ is said to have *order* $m+1$ if no point of $X$ lies in more than $m+1$ of the $U_i$, and some point of $X$ lies in exactly $m+1$ of the $U_i$.
:::

Then we can define the dimension of a space $X$ as follows.

::: Definition 2
A space $X$ is *finite dimensional* if there exists some $m$ such that, whenever an open covering $(U_i)_{i\in I}$ of $X$ is given, there always exists an open refinement $(V_j)_{j\in J}$ of $(U_i)$ of order $m+1$. We define the smallest such $m$ to be the *dimension* of $X$, and write $\dim X$.
:::
...
::: Proposition 4
If there exist two finite dimensional closed subspaces $Y,Z$ of a topological space $X$ such that $X=Y\cup Z$, then $\dim X=\max(\dim Y,\dim Z)$.
:::
::: Proof
:::
...
::: Proposition 5
Any compact subspace of $\mathbb{R}^n$ always has dimension at most $n$.
:::
::: Proof
:::
...
::: Definition 6
A topological space $X$ is *irreducible* if there do not exist nontrivial closed subsets $A,B$ of $X$ such that $X=A\cup B$.
:::
...
::: Proposition 8
Suppose $X$ is a union of irreducible open subsets
...
::: Definition 9
For a subset $A$ of a topological space $X$, the *irreducible component* containing $A$ means the largest irreducible subset containing $A$.
:::
...
::: Definition 10
For a topological space $X$, we define the *length* of a strictly descending chain of irreducible closed subsets of $X$
...
::: Proposition 14
For a topological space $X$ and an open subset $U$, there exists a bijection between irreducible closed subsets of $X$ meeting $U$ and irreducible closed subsets of $U$.
:::
::: Proof
