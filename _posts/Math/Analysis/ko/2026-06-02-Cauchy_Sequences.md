...
이므로, $\varepsilon = \frac12$에 대해서는 아무리 큰 $N$을 잡아도 $m, n \geq N$이면서 $\lvert s_m - s_n\rvert \geq \frac12$인 짝이 존재한다. 따라서 $(s_n)$은 Cauchy 조건을 어기고, [정리 4](#thm4){: data-lid="6zxpg" }의 대우에 의해 발산한다. 극한값을 구하지 않고 발산을 증명한 셈이다.
:::
