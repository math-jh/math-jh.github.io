...
Applying $\sigma$ merely permutes the factors, so $N_{\mathbb{L}/\mathbb{K}}(x)$ is $G$-invariant, and since $\mathbb{L}/\mathbb{K}$ is Galois, by [Theorem 8](/en/math/field_theory/galois_extension#thm8){: data-lid="0c0mf" data-relation="required" } in [\[Galois Extension\] §Galois Extension](/en/math/field_theory/galois_extension){: data-relation="required" } we have $N_{\mathbb{L}/\mathbb{K}}(x)\in\mathbb{K}$.
