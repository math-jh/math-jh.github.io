...
Earlier, in [§Purely Inseparable Extensions, ⁋Example 9](/en/math/field_theory/purely_inseparable_extensions#ex9){: data-lid="ys0cs" data-relation="weak" }, we examined a situation that could cause problems when developing Galois theory; let us revisit this example in light of [Theorem 3](#thm3){: data-lid="jhwvn" data-relation="required" }.
...
[Theorem 14](#thm14){: data-lid="abfxf" data-relation="forward" } shows that a primitive element can always be found for finite degree separable extensions. For this we need the following lemma.
