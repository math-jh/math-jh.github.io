...
Conversely, suppose that $\mathbb{M}/\mathbb{K}$ is a Galois extension. Then in particular $\mathbb{M}/\mathbb{K}$ is quasi-Galois, so by [§Galois Extensions, ⁋Proposition 5](/en/math/field_theory/galois_extension#prop5){: data-lid="29l4f" data-relation="required" }, any $\sigma\in \Gal(\mathbb{L}/\mathbb{K})$ satisfies $\sigma(\mathbb{M})=\mathbb{M}$. Then by $(\ast)$ and the correspondence of [Theorem 1](#thm1){: data-lid="mz7jy" data-relation="required" },
...
:::
::: Proof
First, we show that $\mathbb{L}/\mathbb{M}$ is a Galois extension. Since $\mathbb{L}/\mathbb{K}$ is algebraic, $\mathbb{L}/\mathbb{M}$ is also algebraic. For any $x\in \mathbb{L}$, let the minimal polynomial of $x$ over $\mathbb{K}$ be $f$, and let the minimal polynomial over $\mathbb{M}$ be $g$. Since $f$ is also an element of $\mathbb{M}[\x]$ and $f(x)=0$, $g$ divides $f$ ([§Algebraic Extensions, ⁋Theorem 15](/en/math/field_theory/algebraic_extensions#thm15){: data-lid="lq88o" data-relation="required" }). However, since $\mathbb{L}/\mathbb{K}$ is Galois, by the third condition of [§Galois Extensions, ⁋Theorem 8](/en/math/field_theory/galois_extension#thm8){: data-lid="uguvc" data-relation="required" }, $f$ splits in $\mathbb{L}[\x]$ into a product of distinct linear factors, and hence so does its divisor $g$. That is, $\mathbb{L}/\mathbb{M}$ satisfies the third condition of the same theorem and is therefore a Galois extension.
...
The following lemma is commonly known as *Artin's lemma*, and provides the key counting argument in the proof of [Theorem 1](#thm1){: data-lid="ibf23" data-relation="weak" }.
...
First, we show that $k\circ g=\id_{\Ext(\mathbb{L}/\mathbb{K})}$. For any $\mathbb{M}\in\Ext(\mathbb{L}/\mathbb{K})$, by [Lemma 7](#lem7){: data-lid="pk9im" data-relation="required" }, $\mathbb{L}/\mathbb{M}$ is a Galois extension, and therefore by the first condition of [§Galois Extensions, ⁋Theorem 8](/en/math/field_theory/galois_extension#thm8){: data-lid="dmzua" data-relation="required" }, the $\Gal(\mathbb{L}/\mathbb{M})$-invariant elements are all elements of $\mathbb{M}$. Conversely, it is clear that the elements of $\mathbb{M}$ are fixed by $\Gal(\mathbb{L}/\mathbb{M})$, so $k(g(\mathbb{M}))=\mathbb{M}$.
