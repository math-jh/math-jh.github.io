...
Using prime fields we can define the characteristic of a ring. Suppose a ring $A$ has some subfield. Then by [Theorem 4](#thm4){: data-relation="required" } this $A$ has a unique prime subfield $\mathbb{P}$. Moreover, looking at the proof of [Theorem 4](#thm4){: data-relation="required" }, the way to obtain this $\mathbb{P}$ is given quite explicitly: since $\mathbb{P}$ must contain the multiplicative identity $1$ of $A$, from this
