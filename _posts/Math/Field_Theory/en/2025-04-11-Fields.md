...
::: Proposition 19
For a commutative ring $A$ and polynomial algebra $E=A[\x_i]_{i\in I}$, let $S$ be the subset of $E$ consisting of polynomials $f$ satisfying $df=0$. Then the following hold.
