...
Meanwhile, in the post [\[Algebraic Structures\] §Field of Fractions](/en/math/algebraic_structures/field_of_fractions){: data-lid="r2lsl" data-relation="weak" } we obtained $\mathbb{Q}$ as the total field of fractions $\Frac(\mathbb{Z})$ of $\mathbb{Z}$. The following example gives a field different from $\mathbb{Q}$.
