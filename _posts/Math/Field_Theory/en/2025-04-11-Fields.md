...
That is, for a field $\mathbb{K}$ to be perfect, either (1) the characteristic exponent is $1$, or (2) the characteristic exponent is $q$ and it is a perfect ring in the sense of [Definition 13](#def13){: data-lid="uq1ta" data-relation="weak" }.
