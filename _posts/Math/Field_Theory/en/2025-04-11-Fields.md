...
Earlier we defined every object of $\Ring$ to have $1$, and every ring homomorphism to preserve $1$. ([\[Algebraic Structures\] §Definition of Rings, ⁋Definition 3](/en/math/algebraic_structures/rings#def3)) Thus any subring of a ring $A$ also has a multiplicative identity, which is exactly the multiplicative identity $1$ of $A$. From this we also know that $\mathbb{Z}$ is an initial object of $\Ring$.
