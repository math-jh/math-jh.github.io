...
<ins id="thm4">**Theorem 4**</ins> Suppose a ring $$A$$ has some subfield. Then $$A$$ has a unique prime subfield $$\mathbb{P}$$. In this case, $$\mathbb{P}$$ lies in the center of $$A$$ and is contained in every subfield of $$A$$.
...
<ins id="cor5">**Corollary 5**</ins> A field $$\mathbb{K}$$ has a unique prime subfield $$\mathbb{P}$$, and $$\mathbb{P}$$ is the smallest of the subfields of $$\mathbb{K}$$.
