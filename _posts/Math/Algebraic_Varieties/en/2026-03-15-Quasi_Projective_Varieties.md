...
::: Definition 7
A map $$\varphi:X \rightarrow Y$$ between two varieties $$X \subseteq \mathbb{P}^n$$ and $$Y \subseteq \mathbb{P}^m$$ is called a *morphism* (or *regular map*) if for every $$x\in X$$ there exists a suitable open neighborhood $$U \subseteq X$$ of $$x$$ and homogeneous polynomials $$F_0, \ldots, F_m$$ of the same degree such that
...
::: Proposition 9
Regular maps between affine varieties are exactly the regular maps obtained by viewing them as quasi-projective varieties.
:::
...
::: Example 14
Since we have already examined morphisms between projective varieties and morphisms between affine varieties separately, the functions that tie projective and affine varieties together are the new ones. For example, the canonical surjection
