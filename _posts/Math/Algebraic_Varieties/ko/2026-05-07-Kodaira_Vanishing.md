...
임을 확인하였고, [§선다발과 벡터다발, ⁋예시 16](/ko/math/algebraic_varieties/line_bundles#ex16)에서 $$\mathbb{P}^n$$ 위의 임의의 line bundle은 $$\mathcal{O}(d)$$ 꼴임을 확인하였다. 이 중 $$d>0$$인 $$\mathcal{O}(d)$$들이 ample line bundle이다. 따라서, Kodaira vanishing은 다음의 vanishing
