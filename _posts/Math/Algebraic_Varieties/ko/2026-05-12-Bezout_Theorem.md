...
::: 명제 1 (Bézout)
Algebraically closed field 위에서 정의된 $\mathbb{P}^n$ 안에서, 차수 $d_1, \ldots, d_n$의 hypersurface $H_1, \ldots, H_n$이 공통 성분을 갖지 않는다면
...
::: 명제 4
$\mathbb{P}^2$ 안의 차수 $d$ 곡선 $C = Z(F)$에 대하여, 임의의 일반적인 직선 $L$과의 교차 $C \cap L$은 정확히 $d$개의 점(중복도 포함)으로 이루어진다.
:::
