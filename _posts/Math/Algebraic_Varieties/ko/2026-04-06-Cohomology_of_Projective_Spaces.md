...
[보조정리 5](#lem5){: data-lid="manc3" data-relation="weak" reviewed="" }의 쓸모는 임의의 coherent sheaf를 line bundle들의 direct sum의 quotient로 적을 수 있게 해준다는 것이며, 이로부터 [명제 1](#prop1){: data-lid="bvs1c" data-relation="weak" reviewed="" }의 계산을 임의의 coherent sheaf로 옮길 수 있다.
