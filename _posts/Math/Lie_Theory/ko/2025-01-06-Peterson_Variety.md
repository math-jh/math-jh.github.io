...
Peterson variety는 자연스러운 stratification을 갖는다. $$Y_P^\circ$$의 각 stratum $$Y_{P,w}^\ast$$는 Weyl group element $$w$$에 의해 인덱싱되며, 이는 [§Bruhat decomposition, ⁋정리 13](/ko/math/lie_theory/bruhat_decomposition#thm13)의 Bruhat decomposition을 $$G/B_-$$로 옮긴 형태와 호환된다. 구체적으로
