...
이 글에서 우리는 $$(W, S)$$를 finite Coxeter system이라 한다. 즉, $$W$$는 simple reflection들의 집합 $$S = \{s_1, \ldots, s_r\}$$에 의해 생성되며 ([§Bruhat decomposition, ⁋명제 3](/ko/math/lie_theory/bruhat_decomposition#prop3))
