...
<ins id="ex17">**예시 17**</ins> $$G_\mathbb{C}=\GL(n,\mathbb{C})$$인 경우, Weyl group $$W\cong S_n$$이고 각 permutation $$\sigma\in S_n$$에 대하여 $$\ell(\sigma)$$는 inversion의 개수이다. 이 분해의 구체적 모습과 Gauss elimination과의 관련은 [§Bruhat decomposition, ⁋예시 7](/ko/math/lie_theory/bruhat_decomposition#ex7)에서 다룬다.
