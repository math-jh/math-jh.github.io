...
이 부호 규칙은 르장드르 기호가 군 준동형 $(\mathbb{Z}/p\mathbb{Z})^\times \rightarrow \{\pm 1\}$임을 말한다. 그 kernel은 이차 잉여들로 이루어진 지수 $2$의 subgroup이고, 이것이 명제 2의 “절반”을 군론적으로 설명한다. 같은 관점에서 잉여와 비잉여의 합을 부호로 더하면 서로 상쇄됨을 얻는다.
