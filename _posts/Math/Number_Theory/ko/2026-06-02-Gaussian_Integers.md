...
이러한 나눗셈을 반복하면 두 가우스 정수의 최대공약수를 호제법으로 구할 수 있다 ([§유클리드 호제법과 Bézout 항등식](/ko/math/number_theory/euclidean_algorithm){: data-lid="r6g3j" }의 논증이 그대로 옮겨진다). Norm이 매 단계 진감소하는 양의 정수이므로 알고리즘은 유한 번에 끝난다.
