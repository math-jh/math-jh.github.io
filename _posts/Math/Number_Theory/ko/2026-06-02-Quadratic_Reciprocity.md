...
[§이차 잉여](/ko/math/number_theory/quadratic_residues){: data-lid="j0trt" }에서 르장드르 기호가 multiplicative임을 보았고, 그 계산이 소수와 $-1$에서의 값으로 환원됨을 알았다. $-1$의 경우는 이미 해결했으니, 남은 것은 두 홀수 소수의 르장드르 기호 사이의 관계, 곧 가우스가 "황금 정리"라 부른 이차 상호법칙이다.
