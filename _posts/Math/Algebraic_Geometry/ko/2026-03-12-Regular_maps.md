...
3. $$\mathbb{A}^1 \setminus \{0\} \to V(xy - 1) \subset \mathbb{A}^2$$, $$t \mapsto (t, 1/t)$$는 isomorphism이다. 역사상은 $$(x, y) \mapsto x$$로 주어진다. 이는 hyperbola가 원점을 제외한 직선과 isomorphic함을 보여준다.
