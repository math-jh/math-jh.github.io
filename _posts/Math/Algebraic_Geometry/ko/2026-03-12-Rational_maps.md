...
<ins id="def4">**정의 4**</ins> 기역 준사영다양체 $$X, Y$$ 사이의 *rational map<sub>유리사상</sub>*이란 $$X$$의 어떤 비어있지 않은 열린부분집합 $$U$$에서 정의된 regular map $$\varphi: U \to Y$$를 말한다. 두 rational map $$\varphi: U \to Y$$와 $$\psi: V \to Y$$는 $$U \cap V$$에서 일치할 때 같은 것으로 본다.
...
<ins id="prop9">**명제 9**</ins> 기역 다양체 $$X, Y$$에 대하여 다음이 동치이다.
