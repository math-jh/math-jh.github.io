...
<ins id="ex10">**예시 10**</ins> $$\mathbb{P}^1$$과 $$V(\x\y - \z\w) \subset \mathbb{P}^3$$은 birationally equivalent하다. 둘 다 rational function field $$\mathbb{K}(t)$$를 갖는다.
...
$$$\text{Bl}_0 \mathbb{A}^2 = \{((\x, \y), [u : v]) \in \mathbb{A}^2 \times \mathbb{P}^1 \mid \x v = \y u\}$$$
