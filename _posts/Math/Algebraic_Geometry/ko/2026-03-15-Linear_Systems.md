...
<ins id="ex13">**예시 13**</ins> **$\mathcal{O}_{\mathbb{P}^n}(1)$은 very ample**: [\[사영다양체\] §예시 14](/ko/math/algebraic_geometry/projective_varieties#ex14)에서 보듯, 이는 identity embedding $\mathbb{P}^n \hookrightarrow \mathbb{P}^n$을 정의한다.
