...
2. **Cohomology**: Schubert varieties의 cohomology classes는 $$G(k, n)$$의 cohomology ring의 basis를 이룬다. 이는 그라스만다양체의 "topological invariant"를 계산하는 데 사용된다.
