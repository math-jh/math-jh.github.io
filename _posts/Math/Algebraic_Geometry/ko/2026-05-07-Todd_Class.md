---
title: "Todd Class"
permalink: /ko/math/algebraic_geometry/todd_class
...
가 되어, classical Riemann-Roch theorem이 복원된다. ([§곡선에서의 리만-로흐 정리](/ko/math/algebraic_geometry/riemann_roch_theorem) 참조)
...
을 얻는다. ([§곡면에서의 리만-로흐 정리](/ko/math/algebraic_geometry/riemann_roch_surfaces) 참조)
