...
([§인자](/ko/math/algebraic_geometry/divisors))에서 우리는 rational function의 영점과 극점의 정보를 담는 principal divisor를 정의했다. 이 개념을 임의의 차원으로 확장하면 rational equivalence를 정의할 수 있다.
