...
<ins id="def8">**정의 8**</ins> Coherent sheaf $$\mathcal{F}$$가 *globally generated*라는 것은 evaluation map
...
<ins id="def9">**정의 9**</ins> Coherent sheaf $$\mathcal{F}$$ on $$\mathbb{P}^n$$이 *$$m$$-regular*라는 것은 $$i > 0$$에 대해 $$H^i(\mathbb{P}^n, \mathcal{F}(m-i)) = 0$$인 것이다.

</div>

<div class="proposition" markdown="1">

<ins id="prop10">**명제 10 (Castelnuovo-Mumford Regularity)**</ins> $$\mathcal{F}$$가 $$m$$-regular이면 $$\mathcal{F}(m)$$은 globally generated이고, $$i > 0$$이고 $$k \geq m - i$$인 모든 $$i, k$$에 대해 $$H^i(\mathbb{P}^n, \mathcal{F}(k)) = 0$$이다.
