...
<ins id="def1">**정의 1**</ins> 사영다양체 $$Y \subseteq \mathbb{P}^n$$의 열린부분집합 $$X \subseteq Y$$를 *quasi-projective variety*라 부른다.
...
<ins id="def3">**정의 3**</ins> Quasi-projective variety $$X$$의 *Zariski 위상*은 사영다양체 $$Y$$의 위상을 $$X$$로 제한한 것이다. 즉, $$X$$의 닫힌집합들은 $$X \cap Z$$의 꼴이다. 여기서 $$Z \subseteq \mathbb{P}^n$$은 사영다양체이다.
