...
Line bundle은 복소다양체 이론에서의 복소선다발(complex line bundle)의 대수기하학적 아날로그이다. 복소기하에서 복소선다발은 접다발, 법다발 등 기하학적으로 중요한 구조들을 포착하며, 대수기하에서도 line bundle은 유사한 역할을 한다. 특히 사영다양체 $$\mathbb{P}^n$$ 위에서 *ample* line bundle은 다양체를 사영공간에 매장하는 데 핵심적인 역할을 하고, global section들의 공간 $$H^0(X, \mathcal{L})$$은 다양체의 기하학적 정보를 대수적으로 포착한다. 이렇듯 line bundle은 "위의 함수"의 개념을 일반화하여, 다양체의 기하학을 연구하는 강력한 도구를 제공한다.
...
<ins id="prop18">**명제 18**</ins> [§Divisors](/ko/math/algebraic_geometry/divisors)에서 정의한 *effective divisor* (모든 계수가 음이 아닌 divisor) $$D$$에 대하여, $$H^0(X, \mathcal{O}_X(D))$$는 $$D$$보다 크거나 같은 effective divisor들에 대응되는 rational function들의 공간과 자연스럽게 동형이다.
