...
즉, $$V$$와 $$I$$는 antitone Galois connection을 정의한다. ([\[집합론\] §필터와 아이디얼, 갈루아 대응, ⁋정의 6](/ko/math/set_theory/filter_and_ideal#def6)) Galois connection의 일반적인 성질에 의해 $$VI$$는 $$\mathcal{P}(\mathbb{A}^n)$$ 위에서 closure operator이며, 특히 $$VI(X)$$는 $$X$$를 포함하는 가장 작은 닫힌집합이다. 이를 $$X$$의 *Zariski closure*라 부른다.

한편, [\[집합론\] §필터와 아이디얼, 갈루아 대응, ⁋정의 8](/ko/math/set_theory/filter_and_ideal#def8)에 의하여 연산 $$IV$$ 또한 closure operator를 정의한다. 그렇다면 $$IV$$는 어떨까? 
