...
<ins id="prop3">**명제 3**</ins> "공통 성분이 없다"는 조건이 중요하다. 예를 들어 $$C = D$$이면 무한히 많은 점에서 만난다.
...
<ins id="prop7">**명제 7**</ins> $$\operatorname{CH}^\ast(\mathbb{P}^n) = \mathbb{Z}[H] / (H^{n+1})$$에서 degree $$d_i$$ hypersurface $$H_i$$의 class는 $$d_i H$$이다.
...
<ins id="prop8">**명제 8 (General Bézout)**</ins> $$\mathbb{P}^n$$ 안의 variety $$V, W$$에 대해, $$V$$와 $$W$$가 proper intersection을 가지면:
...
<ins id="prop11">**명제 11 (Pascal's Theorem)**</ins> Conic 위의 6점 $$p_1, \ldots, p_6$$에 대해, $$p_1 p_2$$, $$p_3 p_4$$, $$p_5 p_6$$이 collinear이면 $$p_2 p_3$$, $$p_4 p_5$$, $$p_6 p_1$$도 collinear이다.
...
<ins id="prop13">**명제 13**</ins> $$\mathbb{P}^n_\mathbb{C}$$에서 Bézout's theorem은 topological 의미를 갖는다:
