...
::: Definition 5
For a category $\mathcal{C}$, a *subcategory* of $\mathcal{C}$ is data consisting of a subcollection of the objects and morphisms of $\mathcal{C}$ that itself forms a category.
:::
