...
::: Example 7
Consider in particular the cartesian monoidal category $(\Set,\times)$. ([§Monoidal Categories, ⁋Example 2](/en/math/category_theory/monoidal_categories#ex2){: data-lid="8dbxy" data-relation="required" }) Then the following isomorphism ([\[Set Theory\] §Product of Sets, ⁋Proposition 4](/en/math/set_theory/product_of_sets#prop4){: data-lid="hww5l" data-relation="required" })
