...
Fix an object $A$ of $\mathcal{A}$. Then by the isomorphism of [Definition 1](#def1){: data-relation="required" }, the following functor
...
then this carries exactly the same information as the adjunction of [Definition 1](#def1){: data-relation="required" }.
