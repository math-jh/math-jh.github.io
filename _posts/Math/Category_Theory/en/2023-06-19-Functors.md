...
<ins id="ex3">**Example 3**</ins> Consider the set $$I_1=\{a,b,c\}$$ equipped with the preorder relation given by $$a\leq b\leq c$$. Then the category $$\mathcal{I}_1$$ obtained from $$(I_1,\leq)$$ is represented by the following diagram

![commuting_triangle](/assets/images/Math/Category_Theory/Functors-1.svg){:style="width:8.67em" class="invert" .align-center}
...
![commuting_triangle_F](/assets/images/Math/Category_Theory/Functors-2.svg){:style="width:13.80em" class="invert" .align-center}
...
![covariant hom](/assets/images/Math/Category_Theory/Functors-3.svg){:style="width:15.80em" class="invert" .align-center}
...
![contravariant Hom](/assets/images/Math/Category_Theory/Functors-4.svg){:style="width:15.89em" class="invert" .align-center}
...
<ins id="def10">**Definition 10**</ins> For locally small categories $$\mathcal{A}, \mathcal{B}$$, a functor $$F:\mathcal{A}\rightarrow \mathcal{B}$$ is *faithful* if for any $$A_1,A_2\in\obj(\mathcal{A})$$, the map
