...
::: Example 2
For instance, $\id_\Set:\Set \rightarrow \Set$ is representable. This is because for any singleton $\ast$, the natural isomorphism
...
::: Example 6
Fixing two $k$-vector spaces $V,W$, define the functor $\operatorname{Bilin}(V,W;-)$ from the category $\Vect_k$ to $\Set$ by
...
::: Definition 7
The *category of elements* of a functor $F: \mathcal{A}\rightarrow \Set$ is the category $\int F$ defined by the following data.
