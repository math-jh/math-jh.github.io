...
as defined in [Definition 5](#def5){: data-lid="j2a7z" data-relation="requires-review" } is given, we may identify $A$ with the kernel of $B \rightarrow C$, and when the exact sequence
