---
title: "Limits"
description: "In category theory, we explore the definition of limits through the concepts of cones and cocones, and discuss the universal property of limits using representable functors."
...
date: 2023-06-22
weight: 5
translated_at: 2026-05-30T13:30:05+00:00
translation_source: kimi-cli
last_polished_at: 2026-05-30T13:30:05+00:00
---
...
![Cone](/assets/images/Math/Category_Theory/Limits-1.svg){:style="width:58.34em" class="invert" .align-center}
...
![Functoriality_of_cone](/assets/images/Math/Category_Theory/Limits-2.svg){:style="width:36.99em" class="invert" .align-center}
...
![universal_property-1](/assets/images/Math/Category_Theory/Limits-3.svg){:style="width:36.99em" class="invert" .align-center}

there must exist a unique $f:B \rightarrow\lim F$ making the following diagram commute.

![universal_property-2](/assets/images/Math/Category_Theory/Limits-4.svg){:style="width:37.30em" class="invert" .align-center}
...
Consider the special case $\mathcal{I}=\omega^\op$. Here $\omega$ is the category defined using the poset structure on the ordinal $\omega$, so a diagram indexed by this category has the following form:

![inverse_limit](/assets/images/Math/Category_Theory/Limits-5.svg){:style="width:13.64em" class="invert" .align-center}

The limit of this diagram is called the *inverse limit*; intuitively, drawing $\lim F$ gives the picture

![inverse_limit-2](/assets/images/Math/Category_Theory/Limits-6.svg){:style="width:24.91em" class="invert" .align-center}
...
>
> ![universal_property_of_product](/assets/images/Math/Category_Theory/Limits-7.svg){:style="width:15.13em" class="invert" .align-center}
>
> commute.
...
![equlizer_indexing_category](/assets/images/Math/Category_Theory/Limits-8.svg){:style="width:4.67em" class="invert" .align-center}

A diagram indexed by this category then has the form

![equalizer_diagram](/assets/images/Math/Category_Theory/Limits-9.svg){:style="width:5.32em" class="invert" .align-center}

and the statement that the following diagram

![equalizer_cone](/assets/images/Math/Category_Theory/Limits-10.svg){:style="width:6.32em" class="invert" .align-center}

is a cone means that the two conditions $\lambda_C=f\circ\lambda_B$ and $\lambda_C=g\circ\lambda_B$ hold, and thus $f\circ\lambda_B=g\circ\lambda_B=\lambda_C$. If $A$ is a cone then $\lambda_C$ is determined from $\lambda_B$ in this way, so the only valid information is $\lambda_B:A \rightarrow B$ satisfying $f\circ\lambda_B=g\circ\lambda_B$. Then the limit of this diagram is the universal one among such cones.
:::
...
![equalizer_seq](/assets/images/Math/Category_Theory/Limits-11.svg){:style="width:16.53em" class="invert" .align-center}
...
![equalizer_limit_diagram](/assets/images/Math/Category_Theory/Limits-12.svg){:style="width:22.64em" class="invert" .align-center}
...
![fiber_indexing_category](/assets/images/Math/Category_Theory/Limits-13.svg){:style="width:4.67em" class="invert" .align-center}

A diagram indexed by this category then has the form

![fiber_diagram](/assets/images/Math/Category_Theory/Limits-14.svg){:style="width:5.68em" class="invert" .align-center}
...
![fiber_diagram_limit](/assets/images/Math/Category_Theory/Limits-15.svg){:style="width:8.58em" class="invert" .align-center}
...
![compatibility](/assets/images/Math/Category_Theory/Limits-16.svg){:style="width:12.28em" class="invert" .align-center}
...
::: Theorem 9
If an arbitrary diagram $F:\mathcal{I}\rightarrow \mathcal{A}$ has a limit, then the following natural isomorphism
...
::: Proposition 10
For any bifunctor $F: \mathcal{I}\times \mathcal{J}\rightarrow \mathcal{A}$, if both limits
...
[^1]: Here a *diagram* simply means a functor $F: \mathcal{I} \rightarrow \mathcal{A}$. This terminology is especially intuitive when $\mathcal{I}$ is a partially ordered set viewed as a category, since then the functor $F$ can be thought of as producing a directed system of objects in $\mathcal{A}$ indexed by $I$.
