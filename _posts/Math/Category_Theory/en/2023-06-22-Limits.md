...
::: Example 4
$\Set$ is a complete category. A key ingredient in proving this is the natural isomorphism from [§Representable Functors, ⁋Example 2](/en/math/category_theory/representable_functors#ex2){: data-lid="buqzg" }:
