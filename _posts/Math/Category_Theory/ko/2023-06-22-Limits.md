...
![Cone](/assets/images/Math/Category_Theory/Limits-1.png){:width="1149.6px" class="invert" .align-center}
...
![Functoriality_of_cone](/assets/images/Math/Category_Theory/Limits-2.png){:width="735.75px" class="invert" .align-center}
...
![universal_property-1](/assets/images/Math/Category_Theory/Limits-3.png){:width="735.75px" class="invert" .align-center}

이 주어질 때마다 유일한 $f:B \rightarrow\lim F$가 존재하여 다음 diagram을 commute하게 해야한다.

![universal_property-2](/assets/images/Math/Category_Theory/Limits-4.png){:width="741.6px" class="invert" .align-center}
...
![inverse_limit](/assets/images/Math/Category_Theory/Limits-5.png){:width="282.9px" class="invert" .align-center}

이다. 이 diagram의 limit을 *inverse limit*이라 부르는데, 직관적으로 $\lim F$를 그려보면 다음 그림

![inverse_limit-2](/assets/images/Math/Category_Theory/Limits-6.png){:width="501.3px" class="invert" .align-center}
...
>
> ![universal_property_of_product](/assets/images/Math/Category_Theory/Limits-7.png){:width="311.7px" class="invert" .align-center}
>
> 이 commute한다. 
...
![equlizer_indexing_category](/assets/images/Math/Category_Theory/Limits-8.png){:width="108.9px" class="invert" .align-center}

를 생각하자. 그럼 이 category로 index가 주어진 diagram은

![equalizer_diagram](/assets/images/Math/Category_Theory/Limits-9.png){:width="121.5px" class="invert" .align-center}

와 같은 꼴이며, 다음 diagram

![equalizer_cone](/assets/images/Math/Category_Theory/Limits-10.png){:width="136.05px" class="invert" .align-center}
...
![equalizer_seq](/assets/images/Math/Category_Theory/Limits-11.png){:width="339px" class="invert" .align-center}
...
![equalizer_limit_diagram](/assets/images/Math/Category_Theory/Limits-12.png){:width="457.35px" class="invert" .align-center}
...
![fiber_indexing_category](/assets/images/Math/Category_Theory/Limits-13.png){:width="108.9px" class="invert" .align-center}

를 생각하자. 그럼 이 category로 index가 주어진 diagram은 다음 꼴

![fiber_diagram](/assets/images/Math/Category_Theory/Limits-14.png){:width="123.6px" class="invert" .align-center}
...
![fiber_diagram_limit](/assets/images/Math/Category_Theory/Limits-15.png){:width="179.7px" class="invert" .align-center}
...
![compatibility](/assets/images/Math/Category_Theory/Limits-16.png){:width="256.5px" class="invert" .align-center}
