...
::: 정의 8
Symmetric monoidal category $(\mathcal{A},\otimes)$가 주어졌다 하자. 그럼 $\mathcal{A}$에서의 *internal $\Hom$*은 bifunctor $[-,-]:\mathcal{A}^\op\times \mathcal{A}\rightarrow \mathcal{A}$로서, 임의의 대상 $A\in\obj(\mathcal{A})$에 대해 다음의 adjunction
