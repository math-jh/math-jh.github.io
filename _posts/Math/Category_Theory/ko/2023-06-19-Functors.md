...
![commuting_triangle](/assets/images/Math/Category_Theory/Functors-1.png){:width="186.45px" class="invert" .align-center}
...
![commuting_triangle_F](/assets/images/Math/Category_Theory/Functors-2.png){:width="285.9px" class="invert" .align-center}
...
![covariant hom](/assets/images/Math/Category_Theory/Functors-3.png){:width="314.85px" class="invert" .align-center}
...
![contravariant Hom](/assets/images/Math/Category_Theory/Functors-4.png){:width="316.65px" class="invert" .align-center}
