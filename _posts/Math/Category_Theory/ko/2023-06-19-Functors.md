...
우리는 임의의 preordered set을 category로 볼 수 있다는 것을 살펴보았다. ([§범주, ⁋예시 3](/ko/math/category_theory/categories#ex3)) 다음 예시는 여기에 새로운 관점을 부여한다. 고정된 category $\mathcal{I}$와 임의의 category $\mathcal{A}$에 대하여, functor $F:\mathcal{I}\rightarrow \mathcal{A}$를 *$\mathcal{I}$-shaped diagram in $\mathcal{A}$*라 부르자.
...
::: 정의 7
세 category $\mathcal{A}, \mathcal{B}, \mathcal{C}$에 대하여, [§범주, ⁋예시 12](/ko/math/category_theory/categories#ex12)의 product category로부터의 functor $\mathcal{A}\times \mathcal{B}\rightarrow \mathcal{C}$를 *bifunctor<sub>쌍함자</sub>*라 부른다.
:::
...
이를 통해 category들의 category를 정의할 수 있다. 다만 이전에 언급했던 [\[집합론\] §ZFC 공리계, ⁋예시 1](/ko/math/set_theory/zfc_axioms#ex1)과 관련된 문제를 피하기 위해 우리는 보편적으로 모든 category들의 category 대신, 모든 small category들의 category 혹은 모든 locally small category들의 category를 생각한다.
...
- $\Cat$의 morphism들의 합성은 [보조정리 2](#lem2)의 functor 합성으로 주어진다.
