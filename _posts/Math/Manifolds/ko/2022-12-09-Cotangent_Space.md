...
[§접공간, ⁋명제 2](/ko/math/manifolds/tangent_space#prop2){: data-lid="kygrz" }에 의하여, $\mathcal{C}^\infty_p$의 ideal들의 descending chain
...
으로 정의하는 것이 잘 정의된다. 이렇게 정의된 $v_L$이 linear map일 뿐만 아니라 [§접공간, ⁋정의 3](/ko/math/manifolds/tangent_space#def3){: data-lid="j4hgu" }도 만족한다는 것을 보여야 하므로, 
