...
Let $V,W$ be $n$-dimensional $\mathbb{R}$-vector spaces and let $L:V\rightarrow W$ be a linear map. Then, by the universal property of [\[Multilinear Algebra\] §Tensor Algebras, ⁋Proposition 11](/en/math/multilinear_algebra/tensor_algebras#prop11){: data-lid="9t16q" }, the following linear map
