...
By [§Tangent Space, ⁋Proposition 2](/en/math/manifolds/tangent_space#prop2){: data-lid="kygrz" }, the descending chain of ideals in $\mathcal{C}^\infty_p$
...
is well-defined. We must show that this $v_L$ is not only a linear map but also satisfies [§Tangent Space, ⁋Definition 3](/en/math/manifolds/tangent_space#def3){: data-lid="j4hgu" }; thus we compute
