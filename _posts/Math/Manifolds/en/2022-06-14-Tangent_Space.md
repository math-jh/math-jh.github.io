...
Then this structure becomes a sheaf of rings $\mathcal{C}^\infty_M$ on $M$. ([\[Topology\] §Sheaves, ⁋Definition 1](/en/math/topology/sheaves#def1){: data-lid="be9pk" }) The stalk of $\mathcal{C}^\infty$ at any $p\in M$ is written $\mathcal{C}^\infty_{M,p}$, or simply $\mathcal{C}^\infty_p$ when there is no danger of confusion. ([\[Topology\] §Presheaves, ⁋Definition 9](/en/math/topology/presheaves#def9){: data-lid="jyq1k" })
...
Let us write the equivalence class of $f$ as $\mathbf{f}$. Then the content of [Proposition 1](#prop1){: data-lid="r1jog" } is that scalar multiplication and addition, and even multiplication, are well defined on $\mathcal{C}^\infty_p$, as in $\mathbf{f}\mathbf{g},\mathbf{f}+\mathbf{g}$.
...
::: Proposition 4
The $T_pM$ defined in [Definition 3](#def3){: data-lid="jci0j" } is an $\mathbb{R}$-vector space.
:::
::: Proof
