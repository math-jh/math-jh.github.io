---
title: "Tangent Space"
description: "Starting from tangent vectors on a surface, we define tangent vectors as directional derivative operators and examine the algebraic structure of the tangent space through the sheaf of differentiable functions."
excerpt: "Tangent Vectors and Tangent Space"

categories: [Math / Manifolds]
permalink: /en/math/manifolds/tangent_space
sidebar: 
    nav: "manifolds-en"

date: 2022-06-14
weight: 3
translated_at: 2026-06-01T05:00:05+00:00
translation_source: kimi-cli
last_polished_at: 2026-06-01T05:00:05+00:00
---
...
Then this structure becomes a sheaf of rings $\mathcal{C}^\infty_M$ on $M$. ([\[Topology\] §Sheaves, ⁋Definition 1](/en/math/topology/sheaves#def1){: data-lid="be9pk" data-relation="required" }) The stalk of $\mathcal{C}^\infty$ at any $p\in M$ is written $\mathcal{C}^\infty_{M,p}$, or simply $\mathcal{C}^\infty_p$ when there is no danger of confusion. ([\[Topology\] §Presheaves, ⁋Definition 9](/en/math/topology/presheaves#def9){: data-lid="jyq1k" data-relation="required" })
...
Let us write the equivalence class of $f$ as $\mathbf{f}$. Then the content of [Proposition 1](#prop1){: data-lid="r1jog" data-relation="required" } is that scalar multiplication and addition, and even multiplication, are well defined on $\mathcal{C}^\infty_p$, as in $\mathbf{f}\mathbf{g},\mathbf{f}+\mathbf{g}$.
...
::: Proposition 4
The $T_pM$ defined in [Definition 3](#def3){: data-lid="jci0j" data-relation="required" } is an $\mathbb{R}$-vector space.
:::
::: Proof
