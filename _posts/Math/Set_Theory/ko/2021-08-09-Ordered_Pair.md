...
위 두 명제로부터 $\subseteq$가 집합들 사이의 order relation이 된다는 것을 안다. ([§순서관계의 정의, ⁋정의 2](/ko/math/set_theory/order_relations#def2){: data-lid="kqyue" })
...
또, [정의 7](#def7){: data-lid="1888f" }과 유사하게 집합 $A$와 $B$를 $A\times B$의 첫 번째와 두 번째 성분이라 부른다.
:::
...
[^1]: 물론 이 "집합"은 집합이 아니다. ([§ZFC 공리계, ⁋예시 4](/ko/math/set_theory/zfc_axioms#ex4){: data-lid="p57o8" })
