...
이제 [§이항관계, ⁋정의 6](/ko/math/set_theory/binary_relation#def6){: data-lid="0h5zg" }의 표기를 따르면 ${<}(1)$은 $(1,n)\in{<}$이도록 하는 모든 $n\in\mathbb{N}$들의 모임이고 따라서
...
를 모두 포함하는 것이다. 그러나 [§이항관계들 사이의 연산, ⁋정의 9](/ko/math/set_theory/operation_of_binary_relations#def9){: data-lid="rj8bp" }에서 살펴본 항등함수의 성질에 의해 위의 식들은 모두 $h=f\circ g$와 다를 것이 없다. 반면
