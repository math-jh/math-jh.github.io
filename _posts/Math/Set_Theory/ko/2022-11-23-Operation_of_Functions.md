...
<ins id="def7">**정의 7**</ins> $$f:A\rightarrow B$$가 이변수함수라 하자. 모든 $$y$$에 대하여 $$A_y$$를 $$(x,y)\in A$$이도록 하는 모든 $$x$$들의 집합으로 정의하자. 그럼 $$A_{y_0}$$에서 $$B$$로의 함수 $$x\mapsto f(x,y_0)$$를 $$y_0$$에서의 $$f$$의 *partial mapping*이라 부르고, $$f(-,y_0)$$로 적는다. 이와 비슷하게 $$f(x_0,-)$$ 또한 정의한다.
