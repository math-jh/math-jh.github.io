...
<ins id="prop4">**명제 4**</ins> $$(A_i)_{i\in I}$$가 well-ordered set들의 family이고, 어떠한 $$i,j\in I$$에 대해서도 $$A_i$$와 $$A_j$$ 중 어느 하나는 다른 하나의 segment라 하자. 그럼 집합 $$A=\bigcup_{i\in I}A_i$$ 위에서의 유일한 order relation이 존재한다. 이는 well-ordering이고 $$A_i$$의 segment는 $$A$$의 segment가 되며, $$A$$ 자기자신을 제외한 $$A$$의 segment는 어떤 $$A_i$$의 segment가 된다.
