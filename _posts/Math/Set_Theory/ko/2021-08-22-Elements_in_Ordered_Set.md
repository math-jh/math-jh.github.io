...
<ins id="prop11">**명제 11**</ins>  Ordered set $$(A_i)_{i\in I}$$들의 곱 $$A=\prod A_i$$와 그 부분집합 $$X$$에 대해 $$X_i=\pr_i X$$라 하자. 그럼 $$\sup_AX$$가 존재하는 것과 각각의 $$\sup_{A_i}X_i$$가 존재하는 것은 동치이며, $$\sup_AX=(\sup_{A_i}X_i)$$이다.
{: .proposition}
<details class="proof" markdown="1">
<summary>증명</summary>
