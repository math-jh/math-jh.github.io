...
description: "We define the notions of filters and ideals in ordered sets and lattices, and examine the properties of principal filters, principal ideals, and prime ideals."
...
date: 2022-05-01
weight: 18
translated_at: 2026-06-02T18:30:02+00:00
translation_source: kimi-cli
last_polished_at: 2026-06-02T18:30:02+00:00
---
...
We are mostly interested in the case where $A$ is a lattice. In this case, ([§Directed Sets, ⁋Definition 4](/en/math/set_theory/directed_set#def4){: data-lid="hmj9a" })
...
Fix an antitone Galois connection. From the result $GFG(y)=G(y)$ in [Proposition 7](#prop7){: data-lid="fyrn5" }, substituting $y=F(x)$ for any $x\in A$ gives
...
By definition, $x$ and $y$ being closed with respect to $GF$ and $FG$, respectively, means that $GF(x)=x$ and $FG(y)=y$. From [Proposition 7](#prop7){: data-lid="3b7ns" }, we know that all elements in the images of $F$ and $G$ are closed. Conversely, if an arbitrary element $x$ is closed with respect to $GF$, then $GF(x)=x$ implies that $x$ belongs to the image of $G$, and the corresponding statement for $FG$ is proved similarly.
