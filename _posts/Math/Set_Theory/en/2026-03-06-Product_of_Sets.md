...
Since at least one $(P, \pr_i)$ satisfying the conditions of [Theorem 3](#thm3){: data-lid="b2jpu" data-relation="required" } exists ([Definition 1](#def1){: data-lid="nv6h6" data-relation="required" }), we may take this as the definition of the product set. That is, the product of $(A_i)_{i\in I}$ can be characterized as a set $\prod_{i\in I} A_i$ together with functions $\pr_i:\prod_{i\in I}A_i\rightarrow A_i$ satisfying the following universal property.

{% diagram Math/Set_Theory/Product_of_Sets-2.svg width="13.37em" alt="universal_property_of_product" %}

By the same reasoning as in [§Sum of Sets, ⁋Corollary 9](/en/math/set_theory/sum_of_sets#cor9){: data-lid="uzl6x" data-relation="required" }, one can verify that the object and projections $\pr_i$ satisfying this universal property are unique up to bijection.
...
Here $v$ is the bijection sending $(x_i)_{i\in I}$ to $(x_{u(k)})_{k\in K}$. By [Proposition 2](#prop2){: data-lid="8lx5z" data-relation="required" } above, $F\mapsto F\circ U$ is a bijection.
:::
