...
In [§ZFC Axioms](/en/math/set_theory/zfc_axioms){: data-lid="lumof" data-relation="weak" } we accepted as an axiom that unions exist. The following notation is used somewhat more frequently than the notation we employed when introducing that axiom.
...
::: Proposition 4
Consider a family of sets $(A_i)_{i\in I}$ and a surjective function $f:K\rightarrow I$. Then the two equalities
...
::: Proposition 5
 Let $(A_i)_{i\in I}$ be a family of sets, and suppose the index set $I$ is the union of a family $(J_k)_{k\in K}$. Then
...
::: Proposition 7
 Let $f:A\rightarrow B$ be a function, and let $(B_i)_{i\in I}$ be a family of subsets of $B$. Then
...
::: Proposition 8 (De Morgan's law)
For a family $(A_i)_{i\in I}$ of subsets of a set $A$,
