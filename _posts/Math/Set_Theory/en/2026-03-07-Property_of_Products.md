...
::: Proof
Since $(J_k)_{k\in K}$ is a partition, the functions $f_k:J_k\rightarrow \bigcup_{i\in I} A_i$ form a family of functions with pairwise disjoint domains; hence by [§Sum of Sets, ⁋Proposition 2](/en/math/set_theory/sum_of_sets#prop2){: data-lid="dcwv6" } we obtain a bijection.
:::
