...
::: Definition 1
Let $(\mathfrak{a}_i)_{i\in I}$ be a family of cardinals. The cardinal of the product (resp. sum) of the sets $\mathfrak{a}_i$ is called their *cardinal product* (resp. *cardinal sum*) and is denoted by $\prod_{i\in I}\mathfrak{a}_i$ (resp. $\sum_{i\in I}\mathfrak{a}_i$).
:::
...
::: Proposition 2
Let $(\mathfrak{a}_i)_{i\in I}$ be a family of cardinals, and let $f$ be a bijection from $K$ to $I$. Then
...
:::
::: Proof
By [§Sum of Sets, ⁋Proposition 7](/en/math/set_theory/sum_of_sets#prop7){: data-lid="1u144" }, we may regard the sum of cardinals as the union of a pairwise disjoint family. The first equations are consequences of [§Union and Intersection, ⁋Proposition 4](/en/math/set_theory/union_and_intersection#prop4){: data-lid="cx0l9" } and [§Product of Sets, ⁋Proposition 5](/en/math/set_theory/product_of_sets#prop5){: data-lid="udxxv" }, respectively, and the second equations follow from [§Union and Intersection, ⁋Proposition 5](/en/math/set_theory/union_and_intersection#prop5){: data-lid="gbo4a" } and [§Properties of Products, ⁋Proposition 3](/en/math/set_theory/property_of_products#prop3){: data-lid="c6f2y" }.
:::

::: Proposition 3
Let $(\mathfrak{a}_i)_{i\in I}$ be a family of cardinals, and let $J$ (resp. $K$) be a subset of $I$ satisfying $\mathfrak{a}_i=\mathbf{0}$ for all $i\not\in J$ (resp. $\mathfrak{a}_i=\mathbf{1}$ for all $i\not\in K$). Then
...
Beyond these obvious facts, applying the distributive law between product and union ([§Properties of Products, ⁋Proposition 7](/en/math/set_theory/property_of_products#prop7){: data-lid="w8k31" }) yields the following proposition.
...
Multiplying both sides by $\mathfrak{a}$ and applying [Proposition 4](#prop4){: data-lid="hdhtc" } above, we obtain
...
:::
::: Proof
This is the extension of [§Ordered Pairs, ⁋Proposition 10](/en/math/set_theory/ordered_pair#prop10){: data-lid="5h0nt" } to arbitrary products. The proof is identical.
:::

::: Proposition 6
If $\mathfrak{a}$ and $\mathfrak{b}$ are cardinals satisfying $\mathfrak{a}+\mathbf{1}=\mathfrak{b}+\mathbf{1}$, then $\mathfrak{a}=\mathfrak{b}$.
:::
::: Proof
...
::: Definition 7
Let $\mathfrak{a}$ and $\mathfrak{b}$ be cardinals. The cardinal of the set of functions from $\mathfrak{b}$ to $\mathfrak{a}$ is denoted by $\mathfrak{b}^\mathfrak{a}$.
:::
...
::: Proposition 8
Let $\mathfrak{a}$ and $\mathfrak{b}$ be cardinals, and let $I$ be a set with $\card I=\mathfrak{b}$. If $\mathfrak{a}_i=\mathfrak{a}$ for all $i\in I$, then $\mathfrak{a}^\mathfrak{b}=\prod_{i\in I}\mathfrak{a}_i$.
:::
::: Proof
...
::: Proposition 9
Let $A$ be a set and $\mathfrak{a}$ its cardinal. Then the cardinal of $\mathcal{P}(A)$ is $\mathbf{2}^\mathfrak{a}$.
:::
::: Proof
...
::: Proposition 10 (Cantor)
For any cardinal $\mathfrak{a}$, we always have $\mathbf{2}^\mathfrak{a}>\mathfrak{a}$.
:::
::: Proof
