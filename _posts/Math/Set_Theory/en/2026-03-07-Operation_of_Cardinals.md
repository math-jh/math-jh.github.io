...
:::
::: Proof
By [§Sum of Sets, ⁋Proposition 7](/en/math/set_theory/sum_of_sets#prop7){: data-lid="1u144" data-relation="required" }, we may regard the sum of cardinals as the union of a pairwise disjoint family. The first equations are consequences of [§Union and Intersection, ⁋Proposition 4](/en/math/set_theory/union_and_intersection#prop4){: data-lid="cx0l9" data-relation="required" } and [§Product of Sets, ⁋Proposition 5](/en/math/set_theory/product_of_sets#prop5){: data-lid="udxxv" data-relation="required" }, respectively, and the second equations follow from [§Union and Intersection, ⁋Proposition 5](/en/math/set_theory/union_and_intersection#prop5){: data-lid="gbo4a" data-relation="required" } and [§Properties of Products, ⁋Proposition 3](/en/math/set_theory/property_of_products#prop3){: data-lid="c6f2y" data-relation="required" }.
:::
...
Beyond these obvious facts, applying the distributive law between product and union ([§Properties of Products, ⁋Proposition 7](/en/math/set_theory/property_of_products#prop7){: data-lid="w8k31" data-relation="required" }) yields the following proposition.
...
Multiplying both sides by $\mathfrak{a}$ and applying [Proposition 4](#prop4){: data-lid="hdhtc" data-relation="required" } above, we obtain
