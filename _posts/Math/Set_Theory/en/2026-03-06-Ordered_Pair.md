...
From the two propositions above, we see that $\subseteq$ is an order relation among sets. ([§Definition of Order Relations, ⁋Definition 2](/en/math/set_theory/order_relations#def2){: data-lid="kqyue" data-relation="forward" })
