...
Following the notation of [§Binary Relations, ⁋Definition 6](/en/math/set_theory/binary_relation#def6){: data-lid="0h5zg" data-relation="required" }, ${<}(1)$ is the collection of all $n\in\mathbb{N}$ such that $(1,n)\in\mathbb{N}$, hence
...
However, by the identity function properties examined in [§Operations on Binary Relations, ⁋Definition 9](/en/math/set_theory/operation_of_binary_relations#def9){: data-lid="rj8bp" data-relation="required" }, all the above equations are equivalent to $h=f\circ g$. On the other hand,
