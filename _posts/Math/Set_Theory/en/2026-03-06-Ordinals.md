...
description: "We summarize the motivation for natural numbers and ordinals based on the Peano axioms, and cover the definition and basic properties of well-ordered sets."
...
weight: 19
translated_at: 2026-06-02T16:00:02+00:00
translation_source: kimi-cli
last_polished_at: 2026-06-02T16:00:02+00:00
---
## Introduction
...
<ins id="rmk1">**Remark**</ins> The above proposition does not say that the set $$(-\infty, a]$$ cannot be a segment of $$A$$. Rather, it means that if $$(-\infty, a]$$ is a segment of $$A$$, then this set can also be written in the form $$(-\infty, a')$$ for some $$a'\in A$$.
