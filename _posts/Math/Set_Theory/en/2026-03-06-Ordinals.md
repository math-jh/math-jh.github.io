...
**Remark**</ins> The above proposition does not say that the set $$(-\infty, a]$$ cannot be a segment of $$A$$. Rather, it means that if $$(-\infty, a]$$ is a segment of $$A$$, then this set can also be written in the form $$(-\infty, a')$$ for some $$a'\in A$$.
