...
holds. In this case the negation of $x\leq y$ is $x > y$; without the totally ordered hypothesis this is generally false. ([§Definition of Order Relations, ⁋Remark 11](/en/math/set_theory/order_relations#rmk11){: data-lid="mlqdv" })
...
The preceding proposition also fails for general ordered sets. ([§Monotone Functions, ⁋Remark 6](/en/math/set_theory/monotone_functions#rmk6){: data-lid="5iy57" })
