...
---
The end of the previous post enables us to give new characterizations of injective and surjective functions. ([§Operations on Functions, ⁋Remark 6](/en/math/set_theory/operation_of_functions#rmk6){: data-lid="fwqv2" data-relation="required" })
...
always hold, and the proofs are immediate. If $f$ is injective, then for $r$ defined as in [§Operations on Functions, ⁋Remark 6](/en/math/set_theory/operation_of_functions#rmk6){: data-lid="fp9tu" data-relation="required" },

$$f^{-1}(f(X))=r(f(X))=\id_A(X)=X$$

If $f$ is surjective, then for $s$ defined as in [§Operations on Functions, ⁋Remark 6](/en/math/set_theory/operation_of_functions#rmk6){: data-lid="uo8tg" data-relation="required" },
