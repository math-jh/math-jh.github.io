...
:::
::: Proof
Before beginning the proof proper, we observe that since the two formulas above must hold for <em>all</em> $R$, they must also hold when $R^{-1}$ is substituted for $R$. Therefore, once we prove 1, then 2 follows immediately from [Proposition 2](#prop2){: data-lid="0ektm" }.  
