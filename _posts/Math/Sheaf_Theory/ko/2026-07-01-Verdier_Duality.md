...
::: 정리 9 (Poincaré 쌍대성)
$X$가 connected oriented $n$차원 위상다양체이면 $\omega_X \cong k_X[n]$이고, 각 $p$에 대해 자연스러운 동형
