...
이라 적기로 하자. 그럼 [\[대수적 구조\] §군의 작용, ⁋명제 9](/ko/math/algebraic_structures/group_actions#prop9)에 의해, 임의의 $$g_1,g_2\in G$$와 $$x\in G$$에 대하여
...
은 [\[대수적 구조\] §군 동형사상, ⁋정리 7](/ko/math/algebraic_structures/isomorphism_theorems#thm7)과 [정리 16](#thm16)의 결과이다. 