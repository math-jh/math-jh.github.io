...
::: Theorem 3
For a $$p$$-group $$G$$ of order $$p^r$$, there exists a series of subgroups
...
::: Proposition 4
Let $$G$$ be a $$p$$-group and let $$H\subsetneq G$$ be a subgroup.
...
::: Corollary 9
Let $$P\in\Syl_p(G)$$ and consider its normalizer $$N_G(P)$$. For any subgroup $$M$$ of $$G$$ containing $$N_G(P)$$, the normalizer $$N_G(M)$$ of $$M$$ in $$G$$ equals $$M$$.
:::
...
::: Corollary 10
Let $$f: G_1 \to G_2$$ be a group homomorphism between finite groups. For any Sylow $$p$$-subgroup $$P_1$$ of $$G_1$$, there exists a Sylow $$p$$-subgroup $$P_2$$ of $$G_2$$ containing $$f(P_1)$$.
:::
...
::: Corollary 12
Let $$N$$ be a normal subgroup of $$G$$. Then the image in $$G/N$$ of any Sylow $$p$$-subgroup of $$G$$ is a Sylow $$p$$-subgroup of $$G/N$$, and moreover every Sylow $$p$$-subgroup of $$G/N$$ arises in this way.
:::
...
::: Example 13
Let us classify finite groups $$G$$ of order $$15$$.
