...
description: "This post explores the properties of p-groups, the prime-power subgroups of finite groups. It develops fundamental results including the fixed-point lemma, the nontriviality of the center, and Sylow's theorems."
...
weight: 4
translated_at: 2026-05-31T11:30:03+00:00
translation_source: kimi-cli
last_polished_at: 2026-05-31T11:30:03+00:00
---
## $$p$$-Groups
...
That is, we must show that the size of $$E\setminus E^G$$ is a multiple of $$p$$. Now $$E\setminus E^G$$ is a union of (disjoint) $$G$$-orbits each of size greater than $$1$$, and by [\[Algebraic Structures\] §Group Actions, ⁋Theorem 14](/en/math/algebraic_structures/group_actions#thm14) each such orbit has size a power of $$p$$, whence the claim.

</details>

In particular, if we consider the case $$E=G$$ with $$G$$ acting by inner automorphisms, then $$E^G$$ is precisely the center of $$G$$; thus by [Lemma 2](#lem2) the center $$C(G)$$ of a $$p$$-group $$G$$ is nontrivial.
...
Therefore, by the equivalence of the first and second conditions in [§Series of Groups, ⁋Proposition 7](/en/math/group_theory/series_of_groups#prop7), every $$p$$-group is nilpotent.
