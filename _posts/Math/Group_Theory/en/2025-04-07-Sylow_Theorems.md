...
:::
::: Proof
That is, we must show that the size of $E\setminus E^G$ is a multiple of $p$. But $E\setminus E^G$ is the union of (disjoint) $G$-orbits each of size greater than $1$, and the size of each such orbit is a power of $p$ by [\[Algebraic Structures\] §Group Actions, ⁋Theorem 14](/en/math/algebraic_structures/group_actions#thm14){: data-lid="8cb30" data-relation="required" }, so this holds.
:::

In particular, considering the case where $E=G$ and $G$ acts by inner automorphisms, $E^G$ is exactly the center of $G$, so by [Lemma 2](#lem2){: data-lid="q5psv" data-relation="required" } we know that the center $Z(G)$ of a $p$-group $G$ is not the trivial group.
...
Therefore, by the equivalence of the first and second conditions of [§Series of a Group, ⁋Proposition 7](/en/math/group_theory/series_of_groups#prop7){: data-lid="cbyes" data-relation="required" }, we know that every $p$-group is nilpotent.

On the other hand, by [§Series of a Group, ⁋Proposition 8](/en/math/group_theory/series_of_groups#prop8){: data-lid="owo05" data-relation="required" } we obtain the following.
...
::: Proof
Apply the second result of [Theorem 8](#thm8){: data-lid="5bmy8" data-relation="required" } to the subgroup $f(P_1)$ of $G_2$.
:::
...
Now $P_3\cap P_5$ is a subgroup of both $P_3$ and $P_5$, so its order must be $1$, and therefore $P_3\cap P_5=\{e\}$. Now considering the subgroup $P_3P_5$ of $G$, by [\[Algebraic Structures\] §Isomorphism Theorems, ⁋Theorem 5](/en/math/algebraic_structures/isomorphism_theorems#thm5){: data-lid="s0z6m" data-relation="required" }
