...
::: Proof
Choose $g\in G$ satisfying $M=gMg^{-1}$. Then $gPg^{-1}$ is a Sylow $p$-subgroup of $M$. Therefore there exists $h \in M$ such that $gPg^{-1} = hPh^{-1}$. Now $h^{-1}g \in N_G(P)$ and therefore $g \in hN_G(P) \subset M$.
:::
