...
::: 정의 3
Scheme 사상 $$f:X \rightarrow S$$에 대하여, 대각선 사상 $$\Delta:X \rightarrow X\times_SX$$ ([§값매김환, ⁋정의 3](/ko/math/scheme_theory/valuative_criteria#def3))을 생각하자. $$\Delta$$의 image의 ideal sheaf를 $$\mathcal{I}$$라 할 때, $$X$$ 위의 *cotangent sheaf<sub>여접층</sub>* 혹은 *sheaf of relative differentials* $$\Omega_{X/S}$$를 conormal sheaf
...
::: 정리 8 (Euler 완전열)
Field $$k$$ 위의 사영공간 $$\mathbb{P}^n=\mathbb{P}^n_k$$에 대하여, $$\mathcal{O}_{\mathbb{P}^n}$$-가군층들의 짧은 완전열
