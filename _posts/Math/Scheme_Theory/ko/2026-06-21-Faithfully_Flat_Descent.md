...
반대 방향이 본질적인 부분이다. Descent datum $(N, \varphi_N)$에서 출발하여 $M=N^\varphi$라 두고, 자연스러운 $B$-module morphism
