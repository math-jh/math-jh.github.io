...
::: 예시 2
Ring $$A$$가 discrete valuation ring이라 하자. 즉 $$A$$는 principal ideal domain이곤 두 개의 prime ideal들 $$(0)$$, $$\mathfrak{m}$$을 가지며 이 중 $$\mathfrak{m}$$은 $$A$$의 유일한 maximal ideal로서 non-unit들의 모임이다. 
...
::: 정리 9
Noetherian scheme $$X$$와 scheme morphism $$f:X \rightarrow Y$$에 대하여, $$f$$가 proper인 것은 임의의 valuation ring $$A$$과 그 quotient field $$K=\Frac(A)$$에 대하여, 임의의 scheme morphism $$\Spec A \rightarrow Y$$, $$\Spec K \rightarrow X$$와 다음 commutative diagram
