...
::: 정의 9
*Algebraic torus<sub>대수적 토러스</sub>*는 $\mathbb{G}_m = \mathbb{C}^\ast$의 finite direct sum과 isomorphic한 algebraic group이다. 즉,
...
::: 명제 12
Torus $T$가 affine variety $X = \Spec(A)$ 위에 action하면, coordinate ring $A$는 weight space들로 분해된다:
...
::: 정의 20
Linearization이 주어진 $G$-action on projective variety $X$에 대한 *GIT quotient*는
