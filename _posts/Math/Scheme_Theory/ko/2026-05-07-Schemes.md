...
을 통해 관계 $$\sim$$을 정의할 수 있으며, cocycle condition을 통해 이것이 동치관계임을 증명할 수 있다. 따라서 위상공간으로서 $$X=\coprod_{i\in X_i}X_i\big/{\sim}$$으로 정의하고, [\[위상수학\] §준층, ⁋보조정리 1](/ko/math/topology/presheaves#lem1)과 같은 방식으로 sheaf를 붙일 수 있다는 것을 확인하면 된다. 이를 통해 다음 예시를 보자. 
