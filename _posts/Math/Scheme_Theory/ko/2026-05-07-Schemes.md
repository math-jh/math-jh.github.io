...
일반적으로 affine scheme $$(\Spec A, \mathscr{O}_{\Spec A})$$를 <em-ko>임의의</em-ko> 열린집합으로 제한한 $$(U, \mathscr{O}_{\Spec A}\vert_U)$$가 항상 affine scheme이 되는 것은 아니다. ([예시 8](#ex8)) 그러나 affine scheme $$\Spec A$$의 principal open subset $$D(f)$$는 isomorphism
