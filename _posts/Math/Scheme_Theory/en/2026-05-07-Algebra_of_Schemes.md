...
::: Definition 8
For a point $x$ of a locally Noetherian scheme $X$ and an affine open neighborhood $U\cong \Spec A$ of $x$, we say that $x$ is an *associated point* of $X$ if the prime ideal $\mathfrak{p}_x\subseteq A$ corresponding to $x$ is an associated prime ideal of $A$.
:::
