...
description: "This post covers the notion and properties of vanishing schemes defined as families of global sections, along with locally principal embeddings and effective Cartier divisors."
...
date: 2025-03-08
weight: 16
translated_at: 2026-06-02T03:00:02+00:00
translation_source: kimi-cli
last_polished_at: 2026-06-02T03:00:02+00:00
---
From dimension
...
::: Definition 1
A closed embedding $\iota: Z \hookrightarrow X$ is said to be *locally principal* if there exists an open cover $\{U_i\}$ of $X$ such that, for each of the closed embeddings
...
::: Definition 2
A closed embedding $\iota: Z \hookrightarrow X$ is called an *effective Cartier divisor* if there exists an affine open cover $\{U_i=\Spec A_i\}$ of $X$ such that, for each of the closed embeddings
