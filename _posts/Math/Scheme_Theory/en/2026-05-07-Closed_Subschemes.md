...
::: Example 11
Let us examine a slight variation of the example of a closed embedding from [Example 1](#ex1){: data-lid="infzy" data-relation="weak" }. In this example we write $\mathbb{K}[\x]/(\x^2)$ as $\mathbb{K}[\epsilon]/(\epsilon^2)$ for distinction.
