...
---
In [§Schemes, ⁋Lemma 2](/en/math/scheme_theory/schemes#lem2){: data-lid="3bsbj" } we saw that for an affine scheme $\Spec A$, any element $f$ defines an open affine subscheme $D(f)\cong \Spec A_f$; in particular, to compare the two structure sheaves we applied [\[Topology\] §Sheaves, ⁋Lemma 11](/en/math/topology/sheaves#lem11){: data-lid="04zq8" } to
...
On the other hand, by the second result of [§The Spectrum, ⁋Proposition 9](/en/math/scheme_theory/spectrums#prop9){: data-lid="yo2is" }, given an affine scheme $\Spec A$ and an ideal $\mathfrak{a}$ of $A$, the $\Spec$ functor gives
...
so this property exactly characterizes $\pi$. On the other hand, recalling [\[Commutative Algebra\] §Properties of Localization, ⁋Proposition 4](/en/math/commutative_algebra/properties_of_localization#prop4){: data-lid="3kuvr" }, the surjectivity of $\pi$ can be checked by examining whether the localization $\pi_\mathfrak{p}: A_\mathfrak{p} \rightarrow (A/\mathfrak{a})_{\mathfrak{p}}$ at any prime ideal $\mathfrak{p}$ is surjective, which geometrically amounts to looking at the stalk at any point $\mathfrak{p}$ of the affine scheme $\Spec A$, and therefore by [\[Topology\] §Sheaves, ⁋Proposition 15](/en/math/topology/sheaves#prop15){: data-lid="jedl9" } this is equivalent to $(\Spec\pi)^\sharp$ being surjective.
...
is an isomorphism. This is a condition of exactly the same form as the localization condition required for ideals in [Proposition 6](#prop6){: data-lid="uj3n7" }, but since we do not yet know whether $\varphi$ is an affine morphism, we cannot obtain this with the tools we have. Therefore we will only assert this fact without proof, and complete the remaining argument with the tools we already have. This fact is proved by [§Quasi-coherent Sheaves, ⁋Proposition 18](/en/math/scheme_theory/quasicoherent_sheaves#prop18){: data-lid="7w8bu" } as the quasi-coherence of $\varphi_\ast \mathcal{O}_X$.

Set $C=(\varphi_\ast \mathcal{O}_X)(V)=\Gamma(W, \mathcal{O}_W)$ and $\beta=\varphi^\sharp(V): B \rightarrow C$. Then since the $D(f)$ form a base for $V$, repeating the argument of [§Affine Scheme, ⁋Lemma 8](/en/math/scheme_theory/affine_schemes#lem8){: data-lid="71hpo" } verbatim, from the above fact we obtain for any $\mathfrak{q}\in V$
...
First, $\beta$ is surjective. Indeed, since $\varphi^\sharp$ is surjective, by [\[Topology\] §Sheaves, ⁋Proposition 15](/en/math/topology/sheaves#prop15){: data-lid="nvd0y" } the stalk morphism $B_\mathfrak{q} \rightarrow C_\mathfrak{q}$ at each $\mathfrak{q}$ is surjective, and this is the localization of the $B$-module homomorphism $\beta$, so by [\[Commutative Algebra\] §Properties of Localization, ⁋Proposition 4](/en/math/commutative_algebra/properties_of_localization#prop4){: data-lid="klth0" } the map $\beta$ is surjective. Therefore, setting $\mathfrak{b}=\ker\beta$, we have $C\cong B/\mathfrak{b}$.
...
Now applying the adjunction of [§Affine Scheme, ⁋Theorem 13](/en/math/scheme_theory/affine_schemes#thm13){: data-lid="gxxzz" } to the identity map $C \rightarrow \Gamma(W, \mathcal{O}_W)$ we obtain a canonical morphism $\sigma: W \rightarrow \Spec C$, and by naturality of the adjunction we have $\Spec\beta\circ \sigma=\varphi\vert_W$. On the other hand, $\Spec\beta: \Spec B/\mathfrak{b} \rightarrow \Spec B$ is a homeomorphism onto $Z(\mathfrak{b})$ ([§The Spectrum, ⁋Proposition 9](/en/math/scheme_theory/spectrums#prop9){: data-lid="vjine" }), and $\varphi\vert_W$ is also a homeomorphism onto $\varphi(X)\cap V=Z(\mathfrak{b})$, so $\sigma$ is a homeomorphism. Also for any $x\in W$ and $\mathfrak{q}=\varphi(x)$, the morphism induced by $\sigma$ on stalks is $C_\mathfrak{q} \rightarrow \mathcal{O}_{W,x}$ by [§Affine Scheme, ⁋Lemma 8](/en/math/scheme_theory/affine_schemes#lem8){: data-lid="caqza" }, which is the same as the morphism induced by restriction maps, that is, the isomorphism $C_\mathfrak{q}\cong (\varphi_\ast \mathcal{O}_X)_\mathfrak{q}\cong \mathcal{O}_{W,x}$ obtained above. Therefore $\sigma$ is a homeomorphism and an isomorphism on all stalks, hence an isomorphism of locally ringed spaces.
...
First, from [§The Topological Structure of Schemes, ⁋Lemma 11 (Nike)](/en/math/scheme_theory/topology_of_schemes#lem11){: data-lid="c64ws" } we can cover the intersection of $\Spec A_i$ and $\Spec A_j$ by principal open subsets
...
Then any locally closed embedding is always locally of finite type. To check this, fix an affine open subset $V=\Spec B$ of $Y$. First $Z\cap V$ is covered by principal open subsets $D(f)\cong \Spec B_f$ of $\Spec B$ ([§The Spectrum, ⁋Lemma 11](/en/math/scheme_theory/spectrums#lem11){: data-lid="mt8ef" }), and $B \rightarrow B_f$ is of finite type since it adjoins only $1/f$. Also since $\varphi\vert^Z$ is a closed embedding, by [Proposition 3](#prop3){: data-lid="ej40n" } the preimage of each $D(f)$ is affine and its coordinate ring is a quotient of $B_f$, so the composition $B \rightarrow B_f \rightarrow B_f/\mathfrak{b}$ is also of finite type. That is, $\varphi^{-1}(V)$ is covered by affine open subsets on which $B \rightarrow \mathcal{O}_X(-)$ is of finite type, and therefore by [§Properties of Scheme Morphisms, ⁋Lemma 13](/en/math/scheme_theory/properties_of_scheme_morphisms#lem13){: data-lid="d59qp" } we obtain the same conclusion for any affine open subset of $\varphi^{-1}(V)$.
...
so $\ker\iota_2^\sharp\subseteq \ker\iota_1^\sharp$, and hence by [Definition 5](#def5){: data-lid="t0x36" } we have $\mathcal{I}_{Z_2/X}\subseteq \mathcal{I}_{Z_1/X}$.

Conversely assume $\mathcal{I}_{Z_2/X}\subseteq \mathcal{I}_{Z_1/X}$. Choosing an arbitrary affine open subset $U=\Spec A$ of $X$, by [Proposition 3](#prop3){: data-lid="u5sf1" } the set $\iota_k^{-1}(U)$ is an affine open subset, and from the exact sequence right after [Definition 5](#def5){: data-lid="qa62s" } we have

$$\iota_k^{-1}(U)\cong \Spec A/\mathfrak{a}_k,\qquad \mathfrak{a}_k=\mathcal{I}_{Z_k/X}(U)$$

and the restriction of $\iota_k$ to $\iota_k^{-1}(U)$ corresponds to the canonical projection $A \rightarrow A/\mathfrak{a}_k$. By assumption $\mathfrak{a}_2\subseteq \mathfrak{a}_1$, so $A \rightarrow A/\mathfrak{a}_1$ factors uniquely through $A \rightarrow A/\mathfrak{a}_2$, and the resulting $\pi_U: A/\mathfrak{a}_2 \rightarrow A/\mathfrak{a}_1$ is surjective. Therefore by the discussion right before [Definition 2](#def2){: data-lid="1we66" }, $\varphi_U=\Spec\pi_U: \iota_1^{-1}(U) \rightarrow \iota_2^{-1}(U)$ is a closed embedding, and by construction the restriction of $\iota_1$ to $\iota_1^{-1}(U)$ is the composition of the restriction of $\iota_2$ and $\varphi_U$.

Now it remains to show that $\varphi_U$ and $\varphi_{U'}$ agree on the intersection for two affine open subsets $U=\Spec A$, $U'$ of $X$. By [§The Topological Structure of Schemes, ⁋Lemma 11 (Nike)](/en/math/scheme_theory/topology_of_schemes#lem11){: data-lid="r9lw6" } we can cover $U\cap U'$ by open sets that are principal open in both $U$ and $U'$, and since localization is an exact functor ([\[Commutative Algebra\] §Properties of Localization, ⁋Proposition 2](/en/math/commutative_algebra/properties_of_localization#prop2){: data-lid="c767v" }), on such $D(f)\cong \Spec A_f$ we have $\mathcal{I}_{Z_k/X}(D(f))=\mathfrak{a}_kA_f$. Therefore both $\varphi_U$ and $\varphi_{U'}$ correspond on $D(f)$ to the canonical projection $A_f/\mathfrak{a}_2A_f \rightarrow A_f/\mathfrak{a}_1A_f$ induced by $\mathfrak{a}_2A_f\subseteq \mathfrak{a}_1A_f$, so they agree. Then by [§Morphisms of Schemes, ⁋Proposition 1](/en/math/scheme_theory/morphism_of_schemes#prop1){: data-lid="j27o5" } they glue to a scheme morphism $\varphi: Z_1 \rightarrow Z_2$, and by construction $\iota_1=\iota_2\circ\varphi$.

Finally we show that any $\varphi$ satisfying $\iota_1=\iota_2\circ\varphi$ is a closed embedding. For an affine open subset $U$ of $X$ we have $\varphi^{-1}(\iota_2^{-1}(U))=\iota_1^{-1}(U)$, and the ring homomorphism $A/\mathfrak{a}_2 \rightarrow A/\mathfrak{a}_1$ corresponding to the restriction of $\varphi$ to this open set must commute with the two canonical projections from $A$, so it can only be the above $\pi_U$. But since $\iota_2$ is an affine morphism, as $U$ runs over an affine open cover of $X$ the sets $\iota_2^{-1}(U)$ form an affine open cover of $Z_2$, and since closed embeddings are affine-local on target ([Proposition 3](#prop3){: data-lid="9y7q4" }), $\varphi$ is a closed embedding.
:::
...
Without the assumption of [Corollary 12](#cor12){: data-lid="k2yoc" }, this does not happen.
...
and let $Y=\Spec \mathbb{K}[\x]$. Now on each component of $X$ we can define a scheme morphism $X \rightarrow Y$ via $\x\mapsto \epsilon$. Then from [Example 11](#ex11){: data-lid="f2733" } we know that the image of $X \rightarrow Y$ (as a continuous map) is the single point $0\in \mathbb{A}^1$.
...
More generally, consider an arbitrary scheme $Y$ and a closed subset $X$ of $Y$. Then for any open set $\Spec B$ of $Y$, the closed subset $X\cap \Spec B$ of $\Spec B$ can be written in the form $Z(\mathfrak{b})$ for a radical ideal $\mathfrak{b}$ of $B$ by [§The Spectrum, ⁋Theorem 15](/en/math/scheme_theory/spectrums#thm15){: data-lid="trt0q" }. Moreover, since $\mathfrak{b}$ is by definition the largest among ideals $\mathfrak{b}'$ of $B$ such that $X\cap \Spec B= Z(\mathfrak{b}')$, by [Lemma 9](#lem9){: data-lid="0ly4e" } it is the smallest closed subscheme structure that can be put on $X\cap \Spec B$.
