...
In light of the geometric intuition for (quasi-)finite morphisms we constructed in [§Properties of Scheme Morphisms, ⁋Example 16](/en/math/scheme_theory/properties_of_scheme_morphisms#ex16), it is obvious that at least closed embeddings should always be quasi-finite, and here we can further interpret that they are in fact finite.
