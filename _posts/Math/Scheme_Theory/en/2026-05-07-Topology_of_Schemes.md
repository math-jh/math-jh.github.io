...
it is <em-ko>not</em-ko> that $\mathcal{O}_X(U)$ satisfies $Q$ for any affine open subset $U$, but rather that for any affine open subset $U$ and element $x\in U$, the stalk $\mathcal{O}_{U,x}$ satisfies property $Q$ and thus the affine open subscheme $U$ satisfies property $P$.
