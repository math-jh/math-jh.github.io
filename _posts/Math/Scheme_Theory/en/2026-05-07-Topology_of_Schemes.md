...
::: Example 4
By [[Scheme Theory] §Spectrums, ⁋Lemma 12](/en/math/scheme_theory/spectrums#lem12), any affine scheme is quasi-compact. An example of a scheme that is not quasi-compact is, of course, the disjoint union of infinitely many schemes.
:::
...
Conversely, any irreducible closed subset $Z$ of an affine scheme $\Spec A$ always has the generic point $I(Z)$. ([[Scheme Theory] §Spectrums, ⁋Proposition 16](/en/math/scheme_theory/spectrums#prop16))
:::
