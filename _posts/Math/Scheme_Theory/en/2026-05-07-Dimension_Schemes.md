...
into each monomial $$\alpha_{d_1d_2\cdots d_m}\x_1^{d_1}\cdots\x_m^{d_m}$$ comprising $$f$$ in ($$\ast$$) and expanding, the result consists of a power of $$y_m$$ with constant coefficient
...
The results from [\[Commutative Algebra\] §Integral Extensions and Ideals](/en/math/commutative_algebra/lying_over_and_going_up) are of course the most important ones used in the above statements. Using a similar result, [##ref##](going_down), we obtain the following.
