...
and when a closed embedding $\iota:Z\hookrightarrow Y$ is given by an ideal sheaf $\mathcal{J}$, translating [Proposition 2](#prop2) yields the conormal exact sequence
