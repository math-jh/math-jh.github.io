...
and therefore we see that [Definition 5](#def5){: data-lid="ncflq" data-relation="weak" } generalizes the notion of function values on an affine scheme well. Then from this expression, for any $f\in \mathcal{O}_X(X)$ define
