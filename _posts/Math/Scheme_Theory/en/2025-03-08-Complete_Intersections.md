...
:::
::: Proof
Tensoring the exact sequence of [Proposition 6](#prop6){: data-lid="yrcgj" data-relation="required" } with the invertible sheaf $\mathcal{O}(t)$ preserves exactness, and for a closed embedding we have $(\iota_\ast\mathcal{O}_X)\otimes\mathcal{O}(t)\cong \iota_\ast(\mathcal{O}_X(t))$, with cohomology preserved under $\iota_\ast$. (See the observation just before [§Sheaf Cohomology of Schemes, ⁋Theorem 9](/en/math/scheme_theory/sheaf_cohomology_of_schemes#thm9){: data-lid="xboq3" data-relation="weak" }.) Hence $\rchi(X,\mathcal{O}_X(t))=\rchi(\mathbb{P}^n,\iota_\ast\mathcal{O}_X(t))$, and applying part 2 of [§Sheaf Cohomology of Schemes, ⁋Proposition 15](/en/math/scheme_theory/sheaf_cohomology_of_schemes#prop15){: data-lid="ijrzh" data-relation="required" } to this finite exact sequence and then computing each term via [§Sheaf Cohomology of Schemes, ⁋Corollary 16](/en/math/scheme_theory/sheaf_cohomology_of_schemes#cor16){: data-lid="pudw8" data-relation="required" } yields
