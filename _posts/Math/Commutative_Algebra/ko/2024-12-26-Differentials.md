...
![setup](/assets/frozen/0b5cf7c4/images/Math/Commutative_Algebra/Differentials-1.png){:style="width:6em" class="invert" .align-center}

이 주어졌다 하고, $$\rho$$와 $$\rho'$$를 통해 $$E, E'$$를 각각 $$A$$-algebra와 $$A'$$-algebra로 보자. 그럼 다음의 diagram

![functoriality](/assets/frozen/0b5cf7c4/images/Math/Commutative_Algebra/Differentials-2.png){:style="width:10.4em" class="invert" .align-center}
