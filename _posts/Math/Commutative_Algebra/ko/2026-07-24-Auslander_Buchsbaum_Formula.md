...
[§호몰로지 차원](/ko/math/commutative_algebra/homological_dimension){: data-lid="r8ioc" data-relation="required" }에서 우리는 Noetherian local ring 위의 finitely generated module에 대하여 minimal free resolution을 세우고 projective dimension을 residue field와의 Tor가 소멸하지 않는 가장 높은 차수로 읽어내었으며, [§Depth](/ko/math/commutative_algebra/depth){: data-lid="zo3g0" data-relation="required" }에서는 maximal regular sequence의 길이로 depth를 정의하였다. 이 글은 이 두 불변량이 서로 독립적이지 않다는 Auslander--Buchsbaum 공식
...
이다. $r\geq 1$이므로 $\Ext_A^i(\kappa,A^{\oplus r})=0$인 것은 $\Ext_A^i(\kappa,A)=0$인 것과 동치이다. 그럼 [§Depth, ⁋정리 2](/ko/math/commutative_algebra/depth#thm2){: data-lid="7cfkg" data-relation="required" }가 주는 표현 $\operatorname{depth}X=\min\{i\mid \Ext_A^i(\kappa,X)\neq 0\}$을 $X=F$와 $X=A$에 각각 적용하여
...
:::
::: 증명
$x\in\mathfrak{m}$이 non-unit이므로 $xA\neq A$이고, 따라서 $\overline{A}$는 유일한 maximal ideal $\overline{\mathfrak{m}}=\mathfrak{m}/xA$를 갖는 Noetherian local ring이며 그 residue field는 $\overline{A}/\overline{\mathfrak{m}}=A/\mathfrak{m}=\kappa$이다. 또 $x\in\mathfrak{m}$이고 $M\neq 0$이므로 [§정수적 확장, ⁋보조정리 8](/ko/math/commutative_algebra/integral_extension#lem8){: data-lid="tpyi6" data-relation="required" }에 의하여 $\overline{M}=M/xM\neq 0$이고, 이는 finitely generated $A$-module의 quotient이므로 finitely generated $\overline{A}$-module이다.

(1) $F_\bullet$이 $M$의 projective resolution이므로 [\[호몰로지 대수학\] §Ext와 Tor, ⁋정의 2](/ko/math/homological_algebra/ext_and_tor#def2){: data-lid="mc7ra" data-relation="required" }에 의하여 $H_i(F_\bullet\otimes_A\overline{A})=\Tor_i^A(M,A/xA)$이다. 여기에 [\[호몰로지 대수학\] §Ext와 Tor, ⁋명제 4](/ko/math/homological_algebra/ext_and_tor#prop4){: data-lid="e4fqd" data-relation="required" }의 Tor 대칭성을 쓰면 $\Tor_i^A(M,A/xA)\cong\Tor_i^A(A/xA,M)$이고, $x$가 $A$-regular이므로 [§코쥴 복합체, ⁋따름정리 8](/ko/math/commutative_algebra/koszul_complex#cor8){: data-lid="q17ov" data-relation="required" }에 의하여 이는 다시 Koszul homology $H_i(x;M)$과 isomorphic하다. 그런데 $x$가 $M$-regular이므로 [§코쥴 복합체, ⁋정리 7](/ko/math/commutative_algebra/koszul_complex#thm7){: data-lid="ug5g1" data-relation="required" }에 의하여 $i\geq 1$에서 $H_i(x;M)=0$이고, [§코쥴 복합체, ⁋명제 2](/ko/math/commutative_algebra/koszul_complex#prop2){: data-lid="3al8p" data-relation="required" }에 의하여 $H_0(x;M)=M/xM=\overline{M}$이다. 따라서 $F_\bullet\otimes_A\overline{A}$는 $i\geq 1$에서 homology가 소멸하고 $H_0$이 $\overline{M}$인 complex, 곧 $\overline{M}$의 $\overline{A}$ 위 free resolution이다. 각 $F_i\otimes_A\overline{A}$는 $F_i$가 finitely generated free $A$-module이므로 finitely generated free $\overline{A}$-module이고, minimality는 $d_i(F_i)\subseteq\mathfrak{m}F_{i-1}$로부터 $(d_i\otimes\id)(F_i\otimes_A\overline{A})\subseteq\mathfrak{m}(F_{i-1}\otimes_A\overline{A})=\overline{\mathfrak{m}}(F_{i-1}\otimes_A\overline{A})$이 따라오므로 보존된다.

(2) [§호몰로지 차원, ⁋명제 10](/ko/math/commutative_algebra/homological_dimension#prop10){: data-lid="asr4x" data-relation="required" }에 의하여 minimal free resolution의 계수의 rank는 residue field와의 Tor로 결정된다. 이를 (1)이 준 $\overline{M}$의 minimal free resolution $F_\bullet\otimes_A\overline{A}$에 적용하면
...
을 택하자. 그 길이가 정확히 $p$인 것은 [§호몰로지 차원, ⁋명제 11](/ko/math/commutative_algebra/homological_dimension#prop11){: data-lid="kl0ux" data-relation="required" }에 의한 것이다. Resolution의 exactness에 의하여 $d_p$는 injective이고, minimality에 의하여 $d_p(F_p)\subseteq\mathfrak{m}F_{p-1}$이다. 한편 $\operatorname{depth}A=0$이므로 [§Depth, ⁋정리 2](/ko/math/commutative_algebra/depth#thm2){: data-lid="qle67" data-relation="required" }에 의하여 $\Hom_A(\kappa,A)\neq 0$이고, 따라서 $\mathfrak{m}s=0$을 만족하는 $0\neq s\in A$가 존재한다. 그럼

$$d_p(sF_p)=sd_p(F_p)\subseteq s\mathfrak{m}F_{p-1}=(s\mathfrak{m})F_{p-1}=0$$

이므로 $d_p$의 injectivity로부터 $sF_p=0$이다. 그런데 $F_p\neq 0$은 free이므로 $sF_p=0$은 $s=0$을 강제하여 모순이다. 따라서 $\pd_A M=0$이고, 다시 [§호몰로지 차원, ⁋명제 11](/ko/math/commutative_algebra/homological_dimension#prop11){: data-lid="mixy5" data-relation="required" }에 의하여 minimal free resolution이 $F_0$에서 끝나 $M\cong F_0$은 free이다. 그럼 [명제 1](#prop1){: data-lid="oapq3" data-relation="required" }에 의하여 $\operatorname{depth}M=\operatorname{depth}A$이고, $\pd_A M=0$이므로 공식이 성립한다.

이제 $\delta\geq 1$이라 하고, $\operatorname{depth}$가 $\delta-1$인 모든 Noetherian local ring에 대하여 공식이 성립한다고 가정하자. $M$의 depth에 따라 두 경우로 나눈다.

먼저 $\operatorname{depth}M\geq 1$인 경우를 다룬다. $A$의 zerodivisor 전체는 $\bigcup_{\mathfrak{p}\in\Ass A}\mathfrak{p}$이고 $M$의 zerodivisor 전체는 $\bigcup_{\mathfrak{p}\in\Ass M}\mathfrak{p}$이다. ([§동반소아이디얼, ⁋정리 7](/ko/math/commutative_algebra/associated_primes#thm7){: data-lid="jo7s8" data-relation="required" }) $\operatorname{depth}A\geq 1$과 $\operatorname{depth}M\geq 1$이므로 [§Depth, ⁋따름정리 4](/ko/math/commutative_algebra/depth#cor4){: data-lid="zt5ka" data-relation="required" }의 첫째 결과에 의하여 $\mathfrak{m}$은 $\Ass A$의 어떤 원소에도, $\Ass M$의 어떤 원소에도 포함되지 않는다. $\Ass A$와 $\Ass M$은 유한집합이므로 ([§동반소아이디얼, ⁋정리 7](/ko/math/commutative_algebra/associated_primes#thm7){: data-lid="kq4hp" data-relation="required" }) [§동반소아이디얼, ⁋보조정리 2](/ko/math/commutative_algebra/associated_primes#lem2){: data-lid="nymqp" data-relation="required" }에 의하여 $\mathfrak{m}\subseteq\bigcup_{\mathfrak{p}\in\Ass A\cup\Ass M}\mathfrak{p}$일 수 없고, 따라서 $\Ass A\cup\Ass M$의 어떤 prime에도 속하지 않는 $x\in\mathfrak{m}$이 존재한다. 이러한 $x$는 $A$-regular이면서 $M$-regular이다.

[보조정리 2](#lem2){: data-lid="c2kr0" data-relation="required" }를 이 $x$에 적용하면 $\overline{A}=A/xA$와 $\overline{M}=M/xM$에 대하여 $\pd_{\overline{A}}\overline{M}=\pd_A M<\infty$이고 $\operatorname{depth}_{\overline{A}}\overline{M}=\operatorname{depth}M-1$이며, 같은 보조정리를 $M=A$의 경우에 적용하면 $\operatorname{depth}\overline{A}=\operatorname{depth}A-1=\delta-1$이다. $\operatorname{depth}\overline{A}=\delta-1$이므로 귀납적 가정을 $\overline{A}$ 위의 $\overline{M}$에 적용하여
...
다음으로 $\operatorname{depth}M=0$인 경우를 다룬다. 만일 $M$이 free라면 [명제 1](#prop1){: data-lid="vdxug" data-relation="required" }에 의하여 $\operatorname{depth}M=\operatorname{depth}A=\delta\geq 1$이 되어 $\operatorname{depth}M=0$에 모순이므로 $M$은 free가 아니고, 따라서 $\pd_A M\geq 1$이다. $M$의 minimal free resolution의 첫 단계에서 얻어지는 short exact sequence
...
이제 [§Depth, ⁋명제 10](/ko/math/commutative_algebra/depth#prop10){: data-lid="or6pr" data-relation="required" }의 부등식들을 이 short exact sequence에 적용한다. $F_0$은 free이므로 [명제 1](#prop1){: data-lid="d94te" data-relation="required" }에 의하여 $\operatorname{depth}F_0=\operatorname{depth}A=\delta$이다. 둘째 부등식에서
...
:::
::: 증명
첫째 결과는 [정리 3](#thm3){: data-lid="cqzwf" data-relation="required" }과 $\operatorname{depth}M\geq 0$으로부터 $\pd_A M=\operatorname{depth}A-\operatorname{depth}M\leq\operatorname{depth}A$이다. 둘째 결과의 경우, $\operatorname{depth}A=0$이면 첫째 결과에 의하여 $\pd_A M\leq 0$, 곧 $\pd_A M=0$이므로 [§호몰로지 차원, ⁋명제 11](/ko/math/commutative_algebra/homological_dimension#prop11){: data-lid="9gzj7" data-relation="required" }에 의하여 minimal free resolution이 $F_0$에서 끝나 $M\cong F_0$은 free이다. Artinian local ring $(A,\mathfrak{m})$은 [§조르단-횔더 정리, ⁋정리 4](/ko/math/commutative_algebra/Jordan-Holder_theorem#thm4){: data-lid="awhcz" data-relation="required" }에 의하여 모든 prime ideal이 maximal이므로 $\dim A=0$이고, [§Depth, ⁋따름정리 8](/ko/math/commutative_algebra/depth#cor8){: data-lid="6dq9p" data-relation="required" }에 의하여 $\operatorname{depth}A\leq\dim A=0$이 되어 앞의 경우에 해당한다.
:::
...
:::
::: 증명
[§호몰로지 차원, ⁋명제 13](/ko/math/commutative_algebra/homological_dimension#prop13){: data-lid="wk23h" data-relation="required" }에 의하여 $\operatorname{gldim}A=d$이므로 임의의 $M$에 대하여 $\pd_A M\leq d<\infty$이다. 또 $A$는 [§Cohen-Macaulay 환, ⁋따름정리 5](/ko/math/commutative_algebra/cohen_macaulay_rings#cor5){: data-lid="zhd29" data-relation="required" }에 의하여 Cohen--Macaulay이므로 $\operatorname{depth}A=\dim A=d$이고, [정리 3](#thm3){: data-lid="y07dz" data-relation="required" }에 의하여 $\pd_A M=\operatorname{depth}A-\operatorname{depth}M=d-\operatorname{depth}M$이다. $M$이 Cohen--Macaulay module이면 [§Cohen-Macaulay 환, ⁋정의 1](/ko/math/commutative_algebra/cohen_macaulay_rings#def1){: data-lid="sgpd8" data-relation="required" }에 의하여 $\operatorname{depth}M=\dim M$이므로 $\pd_A M=d-\dim M$을 얻는다.
:::
...
을 얻는다. 두 differential의 성분이 모두 $\mathfrak{m}$에 속하므로 이는 $\mathfrak{m}$의 minimal free resolution이고, $F_2=0$이므로 $\pd_A\mathfrak{m}=1$이다. $A$가 regular local ring이라 $\operatorname{depth}A=\dim A=2$이므로 [정리 3](#thm3){: data-lid="ps53n" data-relation="required" }에 의하여

$$\operatorname{depth}\mathfrak{m}=\operatorname{depth}A-\pd_A\mathfrak{m}=2-1=1$$

이다.

이를 직접 확인해 보자. $A$가 domain이고 $\mathfrak{m}\subseteq A$이므로 곱하기 $\x$는 $\mathfrak{m}$ 위에서 injective이고, [§Depth, ⁋따름정리 4](/ko/math/commutative_algebra/depth#cor4){: data-lid="205l0" data-relation="required" }의 둘째 결과에 의하여 $\operatorname{depth}\mathfrak{m}=\operatorname{depth}(\mathfrak{m}/\x\mathfrak{m})+1$이다. $\mathfrak{m}/\x\mathfrak{m}$에서 $\x$의 class를 $\overline{\x}$라 하면, $\x\in\x\mathfrak{m}=(\x^2,\x\y)$일 경우 $\x=\x(a\x+b\y)$로부터 domain에서 $1=a\x+b\y\in\mathfrak{m}$이 되어 모순이므로 $\overline{\x}\neq 0$이다. 한편 $\x\cdot\overline{\x}=\x^2\in\x\mathfrak{m}$과 $\y\cdot\overline{\x}=\x\y\in\x\mathfrak{m}$으로부터 $\mathfrak{m}\overline{\x}=0$이므로 $\ann(\overline{\x})=\mathfrak{m}$이 되어 $\mathfrak{m}\in\Ass(\mathfrak{m}/\x\mathfrak{m})$이다. 따라서 [§Depth, ⁋따름정리 4](/ko/math/commutative_algebra/depth#cor4){: data-lid="mkn4g" data-relation="required" }의 첫째 결과에 의하여 $\operatorname{depth}(\mathfrak{m}/\x\mathfrak{m})=0$이고, $\operatorname{depth}\mathfrak{m}=0+1=1$로 공식과 부합한다.
:::

다음 예시는 $\pd_A M<\infty$라는 가정을 떼면 공식이 실패한다는 것을, projective dimension이 infinite module로 보여준다.

::: 예시 7
Field $\mathbb{K}$에 대하여 $A=\mathbb{K}[[\x,\y]]/(\x\y)$를 생각하자. 이는 [§Depth, ⁋예시 11](/ko/math/commutative_algebra/depth#ex11){: data-lid="grj1k" data-relation="weak" }에서 살펴본 것처럼 $\operatorname{depth}A=1=\dim A$인 Cohen--Macaulay local ring이다. $\x,\y$의 image를 각각 $\overline{\x},\overline{\y}$로 적고 $M=A/(\overline{\x})$를 생각하자.
