...
$$0 \rightarrow A \xrightarrow{\alpha} B \rightarrow C \rightarrow 0$$
...
로부터 적당한 $a\in A$를 찾아 $a$가 $B/\mathfrak{a}^kB$에서 $b_k-b_{k+1}'$로 옮겨지도록 할 수 있다. 이제 $b_{k+1}=b_{k+1}'+\alpha(a)$로 두면 원하는 결과를 얻는다.
:::
