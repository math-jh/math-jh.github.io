...
:::
::: Proof
1. First, suppose that $M/\mathfrak{a}M$ has finite length. Then, by the argument examined immediately after [Proposition–Definition 3](#prop-def3){: data-lid="i2ceh" }, we know that a sufficiently large power of $\mathfrak{m}$ always annihilates $M/\mathfrak{a}M$, and combining this with [Lemma 4](#lem4){: data-lid="pq3zi" }, we have
...
has finite length, $(a,a_1,\ldots, a_d)$ is an ideal generated by $d+1$ elements such that $M/(a,a_1,\ldots, a_d)M$ has finite length. Therefore, by the third result of [Proposition 6](#prop6){: data-lid="8uyqf" }, $\dim M\leq 1+d$. 
:::
