...
First, recall the definition of the ideal quotient for an arbitrary ring $A$ and two ideals $\mathfrak{a}, \mathfrak{b}$ of $A$. ([§Basic Notions, §§Basic Definitions](/en/math/commutative_algebra/basic_notions#basic-definitions))
