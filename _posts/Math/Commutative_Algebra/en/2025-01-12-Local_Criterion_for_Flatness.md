...
and applying [Lemma 2](#lem2){: data-lid="84lc7" data-relation="required" }, we obtain $\Tor_1^A(A/\mathfrak{m}, M)=0$. Therefore, by [Theorem 1](#thm1){: data-relation="required" }, $M$ is a flat $A$-module.
:::
