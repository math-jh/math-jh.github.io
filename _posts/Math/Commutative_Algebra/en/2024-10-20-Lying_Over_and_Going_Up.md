...
Now let $B'$ be the $A$-subalgebra of $B$ generated by the $b_i$. Then every element of $B'$ is integral, and $B'$ is finitely generated as an $A$-algebra. Therefore, by [§Integral Extensions, ⁋Lemma 4](/en/math/commutative_algebra/integral_extension#lem4), $B'$ is finitely generated as an $A$-module. Applying [§Integral Extensions, ⁋Lemma 8 (Nakayama)](/en/math/commutative_algebra/integral_extension#lem8), we obtain $B'=0$, a contradiction.
:::
