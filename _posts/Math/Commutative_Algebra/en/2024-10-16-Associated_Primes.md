...
::: Proposition 3
Fix an $A$-module $M$, and suppose $\mathfrak{a}$ is maximal among ideals of the form $\ann(x)$. Then $\mathfrak{a}$ is a prime ideal.
:::
::: Proof
...
::: Theorem 7
Let $M$ be a finitely generated module over a Noetherian ring $A$. Then the following hold.
...
::: Corollary 8
For a reduced Noetherian ring $A$, let $K$ be its total ring of fractions. Then $K$ is a finite product of fields.
:::
::: Proof
