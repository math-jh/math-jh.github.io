...
date: 2024-10-20
weight: 11
translated_at: 2026-08-27T15:48:41+00:00
...
::: Proposition 4
Let $M$ be a finitely generated module with an $\mathfrak{a}$-stable filtration $\mathcal{J}$, and suppose that every term $M_k$ of $\mathcal{J}$ is a finitely generated submodule of $M$. Then $\gr_\mathcal{J}M$ is a finitely generated $\gr_\mathfrak{a}A$-module.
:::
::: Proof
...
:::
::: Proof
First, if $\Bl_\mathcal{J}M$ is finitely generated, there exists some $n$ such that these generators are contained in the first $n$ terms of $\Bl_\mathcal{J}M$. Now, by rewriting each of them as a sum of homogeneous elements, $\Bl_\mathcal{J}M$ is generated by these homogeneous elements. From this we know that $\mathcal{J}$ is $\mathfrak{a}$-stable. This argument also works in the opposite direction.
:::
...
Fix a Noetherian ring $A$, its ideal $\mathfrak{a}$, and a finitely generated $A$-module $M$. Then the following hold.
...
::: Definition 9
Let an $A$-module $M$ be given with an $\mathfrak{a}$-filtration
...
::: Example 10
Let $A=\mathbb{K}[\x,\y]$ and $\mathfrak{a}=(\x,\y)$. Then $\gr_\mathfrak{a}A$ is a graded ring whose grading is determined by the degree of polynomials. Now set $M=A$ and consider the $A$-submodule (i.e., ideal of $A$) $\mathfrak{b}=(\x^2, \y^2)$ of $M$. Then every element of $\mathfrak{b}$ is of the form

$$f(\x,\y)\x^2+g(\x,\y)\y^2$$

so $\initial(\mathfrak{b})$ is the homogeneous ideal of $\gr_\mathfrak{a}A$ generated by $\x^2, \y^2$.
:::
