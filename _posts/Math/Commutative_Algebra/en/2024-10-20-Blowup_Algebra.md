...
weight: 11
translated_at: 2026-05-26T12:00:02+00:00
...
<ins id="prop4">**Proposition 4**</ins> Let $$\mathcal{J}$$ be an $$\mathfrak{a}$$-stable filtration on a finitely generated module $$M$$, and suppose that every term $$M_k$$ of $$\mathcal{J}$$ is a finitely generated submodule of $$M$$. Then $$\gr_\mathcal{J}A$$ is a finitely generated $$\gr_\mathfrak{a}A$$-module.
...
Assume $$ab=0$$ in $$A$$; it suffices to show that $$a=0$$ or $$b=0$$. In $$\gr_\mathfrak{a}A$$ we must have $$\initial(a)\initial(b)=0$$, so either $$\initial(x)$$ or $$\initial(y)$$ must be $$0$$. By the corollary above, $$\bigcap \mathfrak{a}^n=0$$, so we must have $$a=0$$ or $$b=0$$.
