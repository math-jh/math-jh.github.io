...
These data can be regarded as a categorical limit, as we saw in [\[Category Theory\] §Limits, ⁋Example 5](/en/math/category_theory/limits#ex5){: data-lid="jta4v" data-relation="weak" }, and therefore they also satisfy the following universal property.
...
::: Definition 1
Fix a ring $A$ and an ideal $\mathfrak{a}$. Then for an $\mathfrak{a}$-filtration of ideals of $A$ ([§Blowup Algebras, ⁋Definition 3](/en/math/commutative_algebra/blowup_algebra#def3){: data-lid="mc5ci" data-relation="required" })
...
we know that this satisfies all the conditions of [\[Topology\] §Open Sets, ⁋Proposition 6](/en/math/topology/open_sets#prop6){: data-lid="6d0vy" data-relation="required" }. Now, for arbitrary $g\in G$ and $U\in \mathcal{N}(0)$, declaring $g+U\in \mathcal{N}(g)$ gives a topology on $G$.

In particular, applying this to the situation of [Definition 1](#def1){: data-lid="xfres" data-relation="required" }, we call the topology defined through the above process the *$\mathfrak{a}$-adic topology*. In this case, since $0\in A$ has the countable local base
