...
In other words, if $M/N$ is a coprimary module, then $N$ is a primary submodule. Also, by [§Associated Primes, ⁋Lemma 5](/en/math/commutative_algebra/associated_primes#lem5){: data-lid="vg2nc" }, any finite intersection of $\mathfrak{p}$-primary submodules is again $\mathfrak{p}$-primary.
...
so by [§Associated Primes, ⁋Lemma 5](/en/math/commutative_algebra/associated_primes#lem5){: data-lid="9djk7" }, every prime in $\Ass M$ arises among the $\mathfrak{p}_k$.
