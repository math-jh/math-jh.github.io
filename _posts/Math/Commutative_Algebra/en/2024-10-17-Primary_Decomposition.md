...
In other words, if $M/N$ is a coprimary module, then $N$ is a primary submodule. Also, by [§Associated Primes, ⁋Lemma 5](/en/math/commutative_algebra/associated_primes#lem5){: data-lid="vg2nc" data-relation="required" reviewed="" }, any finite intersection of $\mathfrak{p}$-primary submodules is again $\mathfrak{p}$-primary.
...
In particular, when $M=A$ and $M'=\mathfrak a$ is an ideal of $A$, the prime ideals containing $\mathfrak a$ that are minimal with respect to inclusion, as in the third part of [Theorem 3](#thm3){: data-lid="m1mg4" data-relation="weak" reviewed="" }, are called the *minimal prime ideals* of $\mathfrak a$; when $\mathfrak a=(0)$, we simply call them the minimal prime ideals of $A$.
...
of the zero submodule $0$ of $M$. Then, generalizing the exact sequence of [\[Multilinear Algebra\] §Exact Sequences, ⁋Proposition 7](/en/math/multilinear_algebra/exact_sequences#prop7){: data-lid="alqlt" data-relation="requires-review" }, we have

$$M\subseteq \bigoplus_{k=1}^n M/M_k,$$

so by [§Associated Primes, ⁋Lemma 5](/en/math/commutative_algebra/associated_primes#lem5){: data-lid="9djk7" data-relation="required" reviewed="" }, every prime in $\Ass M$ arises among the $\mathfrak{p}_k$.
