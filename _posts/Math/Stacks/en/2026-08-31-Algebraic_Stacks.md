...
Now let us apply [Theorem 10](#thm10){: data-lid="s5aj6" data-relation="required" } to the case $U=S$ from [Definition 7](#def7){: data-relation="required" }, i.e. the classifying stack, to read off the atlas and stabilizers directly.
