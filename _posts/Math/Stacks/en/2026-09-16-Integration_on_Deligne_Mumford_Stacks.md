...
Now, integration on stacks and the factor $1/\lvert G\rvert$ arising in the process are naturally deduced from the following definition extending the proper pushforward of [\[Algebraic Varieties\] §Chow Groups, ⁋Proposition 6](/en/math/algebraic_varieties/chow_groups#prop6){: data-relation="required" } to stacks.
...
Recall that in [\[Algebraic Varieties\] §Chow Groups, ⁋Proposition 6](/en/math/algebraic_varieties/chow_groups#prop6){: data-relation="required" }, the pushforward for an integral subvariety $V\rightarrow W$ of the same dimension was simply given by
