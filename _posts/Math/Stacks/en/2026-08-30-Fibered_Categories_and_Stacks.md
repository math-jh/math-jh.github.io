...
is a sheaf. This is because an isomorphism is cut out as a subsheaf by the condition that homomorphisms in both directions compose to the identity. Now, the faithfully flat descent functor $\rMod{A} \rightarrow \Desc(B/A)$ is a categorical equivalence ([\[Schemes\] §Faithfully Flat Descent, ⁋Theorem 6](/en/math/scheme_theory/faithfully_flat_descent#thm6){: data-lid="tby9o" data-relation="required" }), hence in particular it is fully faithful. ([\[Category Theory\] §Functor, ⁋Definition 10](/en/math/category_theory/functors#def10){: data-lid="5swb6" data-relation="weak" }) Full faithfulness says precisely that homomorphisms descend uniquely along the covering $\{\Spec B \rightarrow \Spec A\}$, i.e. the sheaf condition for the $\Hom$ presheaf.
