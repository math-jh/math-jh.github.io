...
[정리 17](#thm17)은 [§그로텐디크 위상, ⁋정리 12](/ko/math/stacks/grothendieck_topology#thm12)의 sheafification adjunction의 2-범주 판본이다. Sheafification이 presheaf를 sheaf로 보내는 left adjoint였듯, stackification은 CFG를 stack으로 보내는 2-범주적 reflection이다. 이 조작 덕분에 우리는 moduli 문제를 우선 CFG로 자유롭게 적은 뒤, 필요하면 stackify하여 하강이 성립하는 대상으로 바꿀 수 있다. 다음 예시가 그 전형이다.
