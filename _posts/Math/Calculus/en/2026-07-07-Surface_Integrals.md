...
::: Example 6
On the sphere of [Example 5](#ex5){: data-lid="o78pm" data-relation="required" reviewed="" }, take the outward orientation. Our goal in this example is to compute the flux of
