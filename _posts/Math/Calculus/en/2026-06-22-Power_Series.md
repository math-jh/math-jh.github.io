...
In particular, substituting $x = 1$ gives $e = \sum 1/n!$, and this number coincides with the natural constant defined as the limit $\lim(1 + 1/n)^n$ in [§Limits of Sequences, ⁋Example 8](/en/math/calculus/sequences#ex8){: data-lid="9zvbn" }.
