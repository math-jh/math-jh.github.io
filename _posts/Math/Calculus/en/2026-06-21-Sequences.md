...
An increasing sequence bounded above and a decreasing sequence bounded below converge. (The limit of an increasing sequence is the supremum of its terms.)
:::
...
The sequence $a_n = (1 + 1/n)^n$ is increasing and bounded above, and thus converges by [Proposition 7](#prop7).
