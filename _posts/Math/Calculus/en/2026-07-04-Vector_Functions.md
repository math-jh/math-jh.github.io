...
The integrand $\lVert \mathbf{r}'(t)\rVert$ is continuous, hence integrable ([§Integration, ⁋Theorem 10](/en/math/calculus/integration#thm10){: data-lid="s9kqi" data-relation="weak" }). We call
