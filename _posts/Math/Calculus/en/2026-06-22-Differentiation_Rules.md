...
---
We covered the definition of differentiation and its basic properties in [§Differentiation and Derivatives](/en/math/calculus/derivatives){: data-lid="65feo" data-relation="required" reviewed="" }. In this post, we treat derivatives of concrete functions and differentiation rules applicable to general functions.
...
The first limit was obtained by the squeeze theorem in [§Limits of Functions, ⁋Example 10](/en/math/calculus/functions_and_limits#ex10){: data-lid="gvxns" data-relation="required" reviewed="" }, and the second follows from the same example's inequality $\lvert 1 - \cos h\rvert \leq h^2/2$, which gives $\lvert(1 - \cos h)/h\rvert \leq \lvert h\rvert/2$.
...
We now define differentiation rules applicable to general forms. In [§Differentiation and Derivatives, ⁋Proposition 4](/en/math/calculus/derivatives#prop4){: data-lid="ogd67" data-relation="weak" reviewed="" } we saw that differentiation behaves well with respect to constant multiples and addition, but it does not simply distribute over products.
...
As $h \rightarrow 0$, the difference quotient in the first term converges to $f'(a)$, $g(a+h)$ converges to $g(a)$ by continuity of $g$ ([§Differentiation and Derivatives, ⁋Proposition 2](/en/math/calculus/derivatives#prop2){: data-lid="hzft9" data-relation="required" reviewed="" }), and the difference quotient in the second term converges to $g'(a)$, so by [§Limits of Functions, ⁋Proposition 5](/en/math/calculus/functions_and_limits#prop5){: data-lid="edoso" data-relation="required" reviewed="" } the sum converges to $f'(a)g(a) + f(a)g'(a)$.
:::
...
::: Proof
Defining $h(t)=1/t$, we have $1/g =h \circ g$, and by the derivative of integer powers $h'(t)=-1/t^2$, so by [Theorem 4](#thm4){: data-lid="xpo63" data-relation="required" reviewed="" } we get $(1/g)'(a) = -g(a)^{-2}g'(a)$. Applying the product rule to $f/g = f\cdot(1/g)$ now yields
...
::: Proof
Let $I$ be the interval on which $f$ is defined and let $J = f(I)$ be its image. Since $f$ is monotone and has an inverse, it is injective, hence strictly monotone, and therefore $f^{-1} : J \rightarrow I$ is continuous by [§Continuous Functions, ⁋Proposition 7](/en/math/calculus/continuity#prop7){: data-lid="t16wr" data-relation="required" reviewed="" }.
...
As $y \rightarrow b$, continuity of $f^{-1}$ gives $x \rightarrow a$, and the expression in parentheses on the right converges to $f'(a)$, so by $f'(a) \neq 0$ and part 4 of [§Limits of Functions, ⁋Proposition 5](/en/math/calculus/functions_and_limits#prop5){: data-lid="bpd9d" data-relation="required" reviewed="" } the above difference quotient converges to $1/f'(a)$. That is, $f^{-1}$ is differentiable at $b$ and $(f^{-1})'(b) = 1/f'(a)$.
:::
...
and the right-hand side becomes $\sum_{n\geq 1} n x^{n-1}$ by [Proposition 1](#prop1){: data-lid="p7bvq" data-relation="required" reviewed="" }, so
