...
::: 예시 6
[예시 5](#ex5){: data-lid="o78pm" data-relation="required" }의 구에, 바깥 방향을 주자. 이 예시에서 우리의 목표는 
