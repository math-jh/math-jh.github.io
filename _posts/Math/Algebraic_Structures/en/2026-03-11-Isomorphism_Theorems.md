...
On the other hand, using [\[Set Theory\] §Examples of Equivalence Relations, ⁋Proposition 7](/en/math/set_theory/examples_of_equivalence#prop7){: data-relation="required" reviewed="" }, we obtain the following proposition.
...
:::
::: Proof
The decomposition following [\[Set Theory\] §Examples of Equivalence Relations, ⁋Definition 8](/en/math/set_theory/examples_of_equivalence#def8){: data-relation="required" reviewed="" }.
:::
...
Suppose there exists a group homomorphism $q': H \rightarrow H'$ satisfying $q'\circ f=q'\circ g$. Then by [Lemma 1](#lem1){: data-relation="required" reviewed="" }, $\ker q'$ is a normal subgroup, and by the condition $q'\circ f=q'\circ g$, since
