...
<ins id="def4">**Definition 4**</ins> Let $$I$$ be a commutative monoid and let $$A,A'$$ be two $$I$$-graded rings. A ring homomorphism $$\phi:A \rightarrow A'$$ is called a *graded homomorphism* if $$\phi(A_i)\subseteq A_i'$$ holds for every $$i\in I$$.
