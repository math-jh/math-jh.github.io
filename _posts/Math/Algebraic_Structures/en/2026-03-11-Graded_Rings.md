...
::: Definition 1
Let $I$ be a commutative monoid and let $(A_i)_{i\in I}$ be an $I$-indexed family of abelian groups. If the multiplication defined on $\bigoplus_{i\in I} A_i$ makes it a ring and, in addition, the condition
...
::: Proposition 2
Suppose every element of $I$ is cancellable and that $\bigoplus_{i\in I} A_i$ is a graded ring. Then $A_0$ is a subring of $A$.
:::
::: Proof
...
::: Example 3
For any abelian group $G$, the free ring $F(G)$ generated by $G$ is an $\mathbb{N}$-graded ring.
:::

## Graded Ring Homomorphisms

::: Definition 4
Let $I$ be a commutative monoid and let $A,A'$ be two $I$-graded rings. A ring homomorphism $\phi:A \rightarrow A'$ is called a *graded homomorphism* if $\phi(A_i)\subseteq A_i'$ for every $i\in I$.
:::
...
::: Example 5
Fix a ring $A$ and consider the *polynomial ring*
...
::: Proposition 6
Let $A=\bigoplus_{i\in I} A_i$ be an $I$-graded ring and let $\mathfrak{a}$ be an ideal of $A$. Then the following are equivalent.
