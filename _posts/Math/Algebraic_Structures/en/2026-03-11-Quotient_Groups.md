...
Meanwhile, through [\[Set Theory\] §Equivalence Relations](/en/math/set_theory/equivalence_relations){: data-relation="required" }, we know that the following two are equivalent:
