...
last_polished_at: 2026-08-16T13:15:05+00:00
---
...
On the other hand, every morphism in $\Grp$ has a coequalizer ([§Group Homomorphisms, ⁋Proposition 8](/en/math/algebraic_structures/isomorphism_theorems#prop8)). Thus, if $\Grp$ had arbitrary coproducts, it would be a cocomplete category, and therefore bicomplete.

However, as noted in [§Direct Product of Groups, ⁋Lemma 1](/en/math/algebraic_structures/direct_products#lem1), it is not at all obvious how to endow the coproduct $\coprod G_i$ in $\Set$ with a group structure ([[Set Theory] §Sum of Sets, ⁋Proposition 5](/en/math/set_theory/sum_of_sets#prop5)).
...
::: Definition 1
Let a family of groups $(G_i)$ be given, and fix subgroups $H_i$ of $G_i$. Then the subgroup consisting of those $x$ satisfying $\pr_ix\in H_i$ for all but finitely many $i$ is called the *restricted sum* of the $G_i$ with respect to the $H_i$, and is denoted $\prod^H G_i$.
