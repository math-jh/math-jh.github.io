...
By the coherence theorem of [\[Category Theory\] §Monoidal Categories, §§Monoidal Categories](/en/math/category_theory/monoidal_categories#monoidal-categories), this defines a ring structure on $F(G)$, and the additive identity of $F(G)$ is $0=(0,0,\ldots)$ while the multiplicative identity is $1=(1,0,\ldots)$. It is not difficult to prove the functoriality of $G\mapsto F(G)$, and moreover the following holds.
