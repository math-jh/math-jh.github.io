...
By definition, a ring homomorphism $$\phi:A\rightarrow B$$ is also a group homomorphism between the two abelian groups $$(A,+,0)$$ and $$(B,+,0)$$. Then the kernel $$\ker f$$ of a ring homomorphism $$\phi$$ is defined as the kernel of this group homomorphism. That is, $$\ker \phi=\phi^{-1}(0)$$. Then by [§Group Homomorphisms, ⁋Proposition 3](/en/math/algebraic_structures/group_homomorphisms#prop3), $$\phi$$ being injective is equivalent to $$\ker \phi=\{0\}$$.
