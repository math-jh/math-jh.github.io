...
In the special case $$A=\mathbb{Z}$$, we recover the contents of [§Abelian Groups, §§Tensor Products](/en/math/algebraic_structures/abelian_groups#tensor-products); the isomorphisms above were omitted in that post for reasons of length.
