...
::: Theorem 1
Let a family $(G_i)$ of abelian groups be given, and consider $\prod^w G_i$ and the inclusion maps $\iota_i$. Then for any abelian group $H$ and group homomorphisms $f_i:G_i\rightarrow H$, there exists a unique group homomorphism $f:\prod^wG_i\rightarrow H$ such that $f_i=f\circ\iota_i$.
:::

Thus, at least among abelian groups, the weak direct product $\prod^w G_i$ becomes a coproduct. We call it as follows.

::: Definition 2
Let a family $(G_i)$ of abelian groups, their weak direct product $\prod^w G_i$, and the inclusion maps $\iota_i$ be given. Then the pair of $\prod^w G_i$ and the $\iota_i$ is called the *direct sum* of the $G_i$, and is denoted by $\bigoplus G_i$.
:::
...
::: Definition 3
For any group $G$ and any two subgroups $H_1,H_2$ of $G$, define $[H_1,H_2]$ to be the subgroup of $G$ generated by the following *commutators*
...
::: Proposition 5
Let $G$ be any group and let $p:G\rightarrow G/[G,G]$ be the quotient homomorphism. Then for any abelian group $H$ and any group homomorphism $f:G \rightarrow H$, there exists $\bar{f}:G/[G,G]\rightarrow H$ satisfying $f=\bar{f}\circ p$.
:::
...
::: Definition 6
For any group $G$, the quotient group $G/[G,G]$ is called the *abelianization* of $G$ and is denoted by $G^\ab$.
:::
...
::: Proposition 8
The forgetful functor $U:\Ab \rightarrow \Set$ has a left adjoint $F_\Ab:\Set \rightarrow\Ab$.
:::
...
::: Example 10
$\Ab$ is a cartesian monoidal category with respect to $\times$. However, $\Hom_\Ab(-,-)$ cannot be regarded as an internal $\Hom$ for this structure. That is,
...
::: Definition 11
For two abelian groups $G,H$, a function $f:G\times H \rightarrow A$ is called *bilinear* if the following two equations
...
::: Definition 13
The representing object of [Theorem 12](#thm12) is called the *tensor product* of $G$ and $H$, and is denoted by $A\otimes B$.
:::
...
::: Definition 16
For a commutative monoid $I$, consider a family $(G_i)_{i\in I}$ of abelian groups indexed by $I$. This is called a *graded abelian group*.
:::
