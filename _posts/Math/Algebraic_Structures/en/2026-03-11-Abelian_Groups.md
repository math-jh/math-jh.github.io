...
First, the universal property of the weak direct product shown in [§Restricted Sums, ⁋Theorem 2](/en/math/algebraic_structures/restricted_sums#thm2) applies particularly well when the group $$H$$ is abelian.
...
<ins id="def2">**Definition 2**</ins> Let a family $$(G_i)$$ of abelian groups, their weak direct product $$\prod^w G_i$$, and the inclusion maps $$\iota_i$$ be given. Then the pair of $$\prod^w G_i$$ and the $$\iota_i$$ is called the *direct sum* of the $$G_i$$, and is denoted by $$\bigoplus G_i$$.
...
<ins id="def3">**Definition 3**</ins> For any group $$G$$ and any two subgroups $$H_1,H_2$$ of $$G$$, define $$[H_1,H_2]$$ to be the subgroup of $$G$$ generated by the following *commutators*
...
holds, so $$[G,G]\leq\ker f$$. Now by [§Isomorphism Theorems, ⁋Proposition 3](/en/math/algebraic_structures/isomorphism_theorems#prop3) we obtain the following.

<div class="proposition" markdown="1">

<ins id="prop5">**Proposition 5**</ins> Let $$G$$ be any group and let $$p:G\rightarrow G/[G,G]$$ be the quotient homomorphism. Then for any abelian group $$H$$ and any group homomorphism $$f:G \rightarrow H$$, there exists $$\bar{f}:G/[G,G]\rightarrow H$$ satisfying $$f=\bar{f}\circ p$$.

</div>

In particular, let any group homomorphism $$f:G\rightarrow H$$ be given. Then by composing $$G\rightarrow H\rightarrow H/[H,H]$$ we obtain a group homomorphism from $$G$$ to the abelian group $$H/[H,H]$$, and by [Proposition 5](#prop5) this induces a group homomorphism from $$G/[G,G]$$ to $$H/[H,H]$$.

<div class="definition" markdown="1">

<ins id="def6">**Definition 6**</ins> For any group $$G$$, the quotient group $$G/[G,G]$$ is called the *abelianization* of $$G$$ and is denoted by $$G^\ab$$.
...
<ins id="ex10">**Example 10**</ins> $$\Ab$$ is a cartesian monoidal category with respect to $$\times$$. However, $$\Hom_\Ab(-,-)$$ cannot be regarded as an internal $$\Hom$$ for this structure. That is,
...
The fundamental reason why the equation in [Example 10](#ex10) cannot hold is quite simple. The reason the above isomorphism held in $$\Set$$ was that for any function $$f:A\times B \rightarrow C$$, once an element of $$A$$ or an element of $$B$$ was fixed, the remaining map became a function from $$B$$ or from $$A$$ to $$C$$.
...
<ins id="def11">**Definition 11**</ins> For two abelian groups $$G,H$$, a function $$f:G\times H \rightarrow A$$ is called *bilinear* if the following two equations
...
By the above argument, if we replace the left-hand side of the first equation in [Example 10](#ex10) with $$\Bilin(G,H;A)$$, then one can verify that we obtain the isomorphism
...
<ins id="thm12">**Theorem 12**</ins> The functor $$\Bilin(G,H;-)$$ is representable.
...
<ins id="def13">**Definition 13**</ins> The representing object of [Theorem 12](#thm12) is called the *tensor product* of $$G$$ and $$H$$, and is denoted by $$A\otimes B$$.
