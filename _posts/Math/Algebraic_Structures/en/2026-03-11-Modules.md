...
We now define $$A$$-modules for an arbitrary ring $$A$$ and investigate their properties. More advanced content on $$A$$-modules can be found in the [Multilinear Algebra](/en/multilinear_algebra/) category.
