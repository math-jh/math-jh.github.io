...
::: Definition 1
Let $$A$$ be a ring and $$\mathfrak{a}$$ a two-sided ideal thereof. The ring $$A/\mathfrak{a}$$ defined as above is called the *quotient ring* of $$A$$ by $$\mathfrak{a}$$.
:::

Then the following holds.

::: Proposition 2
Let $$A$$ be a ring and $$\mathfrak{a}$$ a two-sided ideal. Then the following hold:
...
::: Theorem 3
Let $$\phi:A \rightarrow B$$ be a ring homomorphism with kernel $$\ker \phi$$ and image $$\im\phi$$. Then the following hold:
