...
:::
::: Proof
1. That $\pi$ defines an abelian group homomorphism with respect to addition is a result of [§Quotient Groups](/en/math/algebraic_structures/quotient_groups){: data-lid="t4k4c" }. That $\pi$ preserves multiplication is obtained from the following calculation
...
The following theorem can be regarded as the ring homomorphism version of [§Group Isomorphisms](/en/math/algebraic_structures/isomorphism_theorems){: data-lid="litlx" }.
...
:::
::: Proof
Parts 1 and 3 proceed almost identically to what was treated in [§Group Isomorphisms](/en/math/algebraic_structures/isomorphism_theorems){: data-lid="r7xvb" }; one only needs to verify that the group homomorphism obtained there is in fact also a ring homomorphism in the same manner as part 2 of [Proposition 2](#prop2){: data-lid="xwl8y" }.
...
That the two correspondences $\bar{\mathfrak{b}}\mapsto\pi^{-1}(\bar{\mathfrak{b}})$ and $\mathfrak{b}\mapsto\pi(\mathfrak{b})$ in 4 are inverses of each other and preserve inclusion follows from [§Group Isomorphisms, ⁋Theorem 7](/en/math/algebraic_structures/isomorphism_theorems#thm7){: data-lid="274kd" }. What remains is that this correspondence sends two-sided ideals to two-sided ideals. First, for any $\alpha\in A$ and $x\in\pi^{-1}(\bar{\mathfrak{b}})$,
