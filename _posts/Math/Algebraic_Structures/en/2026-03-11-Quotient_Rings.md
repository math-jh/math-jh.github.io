...
:::
::: Proof
1. That $\pi$ defines an abelian group homomorphism with respect to addition is a result of [§Quotient Groups](/en/math/algebraic_structures/quotient_groups){: data-lid="t4k4c" data-relation="required" reviewed="" }. That $\pi$ preserves multiplication is obtained from the following calculation
