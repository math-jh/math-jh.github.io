...
:::
::: Proof
Since $S$ and $\id_S$ trivially satisfy the universal property, by the preceding [Proposition 1](#prop1){: data-lid="pvr0y" data-relation="required" }, any abelian group satisfying the universal property must be isomorphic to $S$.
:::
