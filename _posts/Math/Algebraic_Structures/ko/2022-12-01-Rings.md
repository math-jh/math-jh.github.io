...
<ins id="def1">**정의 1**</ins> Symmetric monoidal category $$(\Ab,\otimes, \mathbb{Z})$$의 monoid object를 *ring<sub>환</sub>*이라 부른다. ([§가환군, ⁋정리 14](/ko/math/algebraic_structures/abelian_groups#thm14))
