...
![associativity](/assets/images/Math/Algebraic_Structures/Algebraic_structures-1.png){:width="245.25px" class="invert" .align-center}
...
![commutativity](/assets/images/Math/Algebraic_Structures/Algebraic_structures-2.png){:width="288.6px" class="invert" .align-center}
