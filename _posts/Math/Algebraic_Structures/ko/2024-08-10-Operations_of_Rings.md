...
Abelian group의 경우 direct sum이 coproduct가 되지만 ([§가환군, ⁋정리 1](/ko/math/algebraic_structures/abelian_groups#thm1){: data-relation="weak" }), ring에서는 그렇지 않다. 따라서 ring들의 coproduct는 따로 정의해야 한다.
