...
<ins id="def11">**정의 11**</ins> 임의의 원소가 가역인 monoid를 *group<sub>군</sub>*이라 부른다. 만일 $$\star$$가 교환법칙을 만족한다면, 이를 *abelian group<sub>아벨군</sub>* (혹은 *commutative group<sub>가환군</sub>*)이라 부른다. 
...
<ins id="ex16">**예시 16**</ins> 정$$n$$각형($$n\ge3$$)을 자기 자신으로 옮기는 평면의 대칭들은 합성에 대하여 group을 이루며, 이를 *dihedral group<sub>이면군</sub>* $$D_n$$이라 부른다. 이러한 대칭은 중심을 축으로 한 $$2\pi/n$$의 정수배 회전 $$n$$개와, $$n$$개의 대칭축에 대한 reflection $$n$$개로 이루어지므로 $$\lvert D_n\rvert=2n$$이다.
