...
By [Theorem 8](#thm8){: data-relation="required" reviewed="" }, characteristic classes of bundles with structure group $G$ are precisely cohomology classes of $\B G$ pulled back via the classifying map. Thus characteristic class theory is the same as computing the cohomology ring of $\B G$, and we summarize this for the most basic groups.
