...
For convenience, let us call a topological manifold of dimension $m$ an *$m$-manifold*. Although not treated in [Definition 1](#def1){: data-lid="ja3bx" data-relation="weak" }, we sometimes replace $\mathbb{R}^m$ in the above definition by the *half-space*
