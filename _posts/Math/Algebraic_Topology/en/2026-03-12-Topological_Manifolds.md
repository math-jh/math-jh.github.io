...
An open subspace $$U$$ of an $$m$$-manifold $$M$$ is again an $$m$$-manifold. Indeed, letting $$\mathcal{B}$$ be a base for $$M$$, the collection
...
Let $$M_1$$ and $$M_2$$ be topological manifolds of dimensions $$m_1$$ and $$m_2$$, respectively. Then $$M_1\times M_2$$ is an $$(m_1+m_2)$$-manifold. Indeed, letting $$\mathcal{B}_i$$ be a base for $$M_i$$, the collection
...
::: Proposition 6
For the quotient map $$X \rightarrow X/R$$, suppose $$X$$ is second-countable and $$X/R$$ is locally Euclidean. Then $$X/R$$ is second-countable.
:::
::: Proof
