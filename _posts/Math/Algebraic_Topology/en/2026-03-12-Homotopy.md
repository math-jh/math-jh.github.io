...
::: Proposition 6
For continuous maps $f_0,f_1:X\rightarrow Y$, if $f_0$ and $f_1$ are homotopic then $C_\bullet(f_0)$ and $C_\bullet(f_1)$ are chain homotopic. ([§Long Exact Sequence, ⁋Definition 5](/en/math/homological_algebra/long_exact_sequence#def5))
:::
::: Proof
