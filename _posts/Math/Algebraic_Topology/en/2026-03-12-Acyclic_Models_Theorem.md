...
The obvious maps between them, when lifted via [Theorem 3](#thm3){: data-relation="required" reviewed="" }, yield a diagram in $\Ch_{\geq0}(\lMod{A})$ that commutes up to natural chain homotopy
