...
This is, as we saw for real bundles in [§Stiefel-Whitney Characteristic Classes, §§Grassmannians](/en/math/algebraic_topology/stiefel_whitney_classes#grassmannians), the *universal family* for complex line bundles. That is, any complex line bundle is obtained uniquely as a pullback of $\gamma$, so the first Chern class gives a bijection
