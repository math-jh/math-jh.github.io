...
Path-connected, locally path-connected, semi-locally simply connected space $B$에 대하여, connected covering space들의 isomorphism class들의 집합과, $\pi_1(B)$의 subgroup의 conjugacy class들 사이의 Galois correspondance가 존재한다. 
:::
...
위상공간 $X$가 두 connected open subset $U,V$의 합집합으로 나타난다고 하고, $U\cap V$가 connected라 하자. 그럼 다음의 diagram
