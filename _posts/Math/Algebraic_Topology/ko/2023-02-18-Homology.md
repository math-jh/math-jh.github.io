...
이렇게 얻어지는 chain complex $$(C^\Delta_k(X),\partial_k)$$의 $$n$$번째 호몰로지를 *$$n$$번째 simplicial homology<sub>$n$번째 심플렉스 호몰로지</sub>*라 부르고, $$H_n^\Delta(X)$$로 적는다. ([\[호몰로지 대수학\] §호몰로지, ⁋정의 2](/ko/math/homological_algebra/homology#def2)) 
