...
먼저 소개할 심플렉스는 homology 이론을 전개할 때 직관적인 이해에 도움을 준다.
...
반면 공간 $D^2\setminus {(0,0)}$의 첫 번째 homology는 $0$이 아니다. 가령 다음의 폐곡선
...
그러나, 물론, 가장 중요하다고 할 수도 있는 성질은 functoriality일 것이다. 그런데 우리는 이미 $\Ab$들의 chain complex들의 category $\Ch_{\geq 0}(\Ab)$에서, 각각의 $n$에 대하여 $n$th homology를 계산하는 $H_n:\Ch_{\geq 0}(\Ab)\rightarrow \Ab$는 functor임을 안다. 따라서 합성 
