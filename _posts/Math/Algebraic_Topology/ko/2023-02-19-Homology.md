...
![Torus](/assets/images/Math/Algebraic_Topology/Homology-1.png){:width="700px" class="invert" .align-center}
...
![Torus_U](/assets/images/Math/Algebraic_Topology/Homology-2.png){:width="200px" class="invert" .align-center}
...
![Torus_L](/assets/images/Math/Algebraic_Topology/Homology-3.png){:width="200px" class="invert" .align-center}
