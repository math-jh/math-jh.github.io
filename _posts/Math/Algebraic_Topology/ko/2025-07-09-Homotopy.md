...
<ins id="prop6">**명제 6**</ins> 연속함수 $$f_0,f_1:X\rightarrow Y$$에 대하여, 만일 $$f_0,f_1$$가 homotopically equivalent라면 $$C_\bullet(f_0), C_\bullet(f_1)$$는 chain homotopic하다. ([\[호몰로지 대수학\] §긴 완전열, ⁋정의 5](/ko/math/homological_algebra/long_exact_sequence#def5))
