...
::: 정의 10
만일 두 path $\alpha_0,\alpha_1:I\rightarrow X$ 사이의 path homotopy가 존재한다면, 이들이 *path homotopic*하다고 말하고 $\alpha_0\sim \alpha_1$로 표기한다. 
:::
...
::: 정의 11
위의 결과들에 의해 $C(I,X)/{\sim}$은 groupoid를 이루며, 이를 $X$의 *fundamental groupoid*라 부르고 $\Pi_1(X)$로 적는다. ([\[범주론\] §범주, ⁋정의 11](/ko/math/category_theory/categories#def11))
:::
