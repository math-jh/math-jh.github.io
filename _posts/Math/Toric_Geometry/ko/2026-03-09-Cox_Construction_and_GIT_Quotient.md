...
Cox construction은 toric variety의 birational geometry를 이해하는 데에도 강력한 도구를 제공한다. [§토릭 다양체의 정의, ⁋명제 8](/ko/math/toric_geometry/toric_varieties#prop8)에서 보았듯이, lattice polytope으로부터 projective toric variety를 구성할 수 있다. Cox construction의 관점에서, 이러한 polytope들의 변화는 GIT quotient에서 linearization의 변화에 대응한다.
