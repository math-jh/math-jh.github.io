...
::: Definition 1
An abelian group $N$ isomorphic to $\mathbb{Z}^n$ is called a *lattice*. The *dual lattice* of a lattice $N$ is given by the formula
...
::: Definition 2
A subset $\sigma$ of $N_{\mathbb{R}}$ is called a *strongly convex rational polyhedral cone* if it satisfies the following conditions:
...
::: Definition 3
A *face* $\tau$ of a cone $\sigma$ is obtained as
...
::: Definition 4
For a cone $\sigma$, define the semigroup
...
([\[Algebraic Structures\] §Algebras, ⁋Definition 5](/en/math/algebraic_structures/algebras#def5){: data-lid="117ax" }) Here $\rchi^u$ is the monomial corresponding to the element $u \in M$.
:::
...
::: Example 6
When $\sigma = \{0\}$, we have $\sigma^\vee = M_{\mathbb{R}}$ and hence $S_\sigma = M$. Therefore
...
::: Example 7
Consider the case $N = \mathbb{Z}^2$ where $\sigma$ is generated by $e_1$ and $e_2$. Then
...
In particular, for a two-dimensional cone in $N = \mathbb{Z}^2$ it suffices to check that the $2 \times 2$ matrix formed by the two ray generators has determinant $\pm 1$, and indeed [Example 7](#ex7){: data-lid="cwte2" } satisfies this.
...
Building on this understanding of the torus, we now define a $T_N$-action on $U_\sigma = \Spec(\mathbb{C}[S_\sigma])$. Since $\Spec$ is a contravariant functor, a geometric action $T_N \times U_\sigma \rightarrow U_\sigma$ is encoded by a comodule structure on the coordinate ring $\mathbb{C}[S_\sigma]$; how this contravariance manifests at the level of points will be checked directly in [Example 14](#ex14){: data-lid="uyayd" }.
...
::: Proposition 10
The algebraic torus $T_N$ acts on the affine toric variety $U_\sigma = \Spec(\mathbb{C}[S_\sigma])$. First define the $\mathbb{C}$-algebra homomorphism $\rho$ on the coordinate ring $\mathbb{C}[S_\sigma]$ by
...
::: Proposition 11
Every affine toric variety $U_\sigma$ contains the torus $T_N$ as an open dense subset.
:::
...
::: Lemma 12 (Separation lemma)
For a face $\tau$ of a cone $\sigma$ there exists an element $u \in S_\sigma$ satisfying
...
::: Proposition 13
For a face $\tau$ of a cone $\sigma$, the variety $U_\tau$ is a principal open subset of $U_\sigma$. ([\[Algebraic Varieties\] §Affine Varieties, ⁋Definition 5](/en/math/algebraic_varieties/affine_varieties#def5){: data-lid="kc019" }) Specifically, choosing $u \in S_\sigma$ with $\tau = \sigma \cap u^{\perp}$, we have

$$U_\tau = \{ x \in U_\sigma \mid \rchi^u(x) \neq 0 \}.$$
:::

::: Proof
Let $u \in S_\sigma$ with $\tau = \sigma \cap u^\perp$. By [Lemma 12](#lem12){: data-lid="cww19" } we have $\tau^\vee = \sigma^\vee + \mathbb{R}_{\ge 0}(-u)$, so
...
::: Example 14
In [Example 7](#ex7){: data-lid="w82de" } we saw that when $N = \mathbb{Z}^2$ and $\sigma = \mathbb{R}_{\geq 0}e_1+ \mathbb{R}_{\geq 0}e_2$, we have $U_\sigma = \mathbb{C}^2$. Let us now examine concretely how the torus $T_N = (\mathbb{C}^\ast)^2$ acts on $U_\sigma = \mathbb{C}^2$.

First, as we saw in [Example 7](#ex7){: data-lid="5hr15" }, $\mathbb{C}[S_\sigma] = \mathbb{C}[\z_1, \z_2]$ (with $\z_i = \rchi^{e_i^\ast}$), and $U_\sigma = \Spec(\mathbb{C}[\z_1, \z_2]) = \mathbb{C}^2$. By [Proposition 10](#prop10){: data-lid="k15rn" }, an element $t = (t_1, t_2) \in T_N = (\mathbb{C}^\ast)^2$ acts on the coordinate ring by
...
Let us now examine the orbit structure of this action. The open dense orbit provided by [Proposition 11](#prop11){: data-lid="0x8w0" } is
...
::: Proposition 15
For an affine toric variety $U_\sigma$ the following hold:
