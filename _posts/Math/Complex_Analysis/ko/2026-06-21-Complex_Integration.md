...
::: 정의 7
열린집합 $$\Omega \subseteq \mathbb{C}$$ 위의 함수 $$f$$에 대하여, $$\Omega$$에서 정칙이고 $$F'(z) = f(z)$$ ($$z \in \Omega$$) 를 만족하는 함수 $$F$$를 $$f$$의 *원시함수<sub>primitive</sub>* 혹은 *antiderivative<sub>역도함수</sub>*라 한다.
:::
