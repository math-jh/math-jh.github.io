...
so the desired value is $d-\rchi(C, \mathcal{H})$. Now by [Proposition 4](#prop4){: data-lid="arwum" } and [\[Schemes\] §Sheaf Cohomology of Schemes, ⁋Corollary 4](/en/math/scheme_theory/sheaf_cohomology_of_schemes#cor4){: data-lid="tpsgt" },
...
holds. Substituting $\sum_jg_j=g-d+c-1$ given by [Proposition 2](#prop2){: data-lid="b8s52" } into this,
