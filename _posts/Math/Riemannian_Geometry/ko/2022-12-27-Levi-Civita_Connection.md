...
<ins id="prop8">**명제 8**</ins> [정의 7](#def7)의 parallel transport는 well-defined이다. 즉 임의의 초기값 $$v_0 \in T_{\gamma(t_0)} M$$에 대해 [정의 7](#def7)의 식과 초기값 조건을 동시에 만족하는 parallel vector field $$V$$가 유일하게 존재한다.
