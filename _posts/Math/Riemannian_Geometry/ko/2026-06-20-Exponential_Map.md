...
::: 예시 10
유클리드 공간 $\mathbb{R}^n$에 standard metric을 주자. [§측지선, ⁋예시 8](/ko/math/riemannian_geometry/geodesics#ex8)에서 보았듯 측지선은 직선 $\gamma_v(t) = p + tv$이며, 이는 모든 $t \in \mathbb{R}$에서 정의된다. 따라서 $\mathcal{E}_p = T_p M = \mathbb{R}^n$이고
