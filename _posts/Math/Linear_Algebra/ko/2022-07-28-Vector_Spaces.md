...
벡터공간은 abelian group $V$ 위에 추가적인 구조인 $\mathbb{K}$-스칼라곱이 정의된 형태이다. 때문에 $V$는 abelian group이 갖는 성질을 모두 갖는다. ([§가환군과 체, ⁋명제 2](/ko/math/linear_algebra/fields#prop2){: data-lid="ope03" } 그리고 [§가환군과 체, ⁋따름정리 3](/ko/math/linear_algebra/fields#cor3){: data-lid="gjx11" })
...
:::
::: 증명
처음 두 주장은 [§가환군과 체, ⁋명제 6](/ko/math/linear_algebra/fields#prop6){: data-lid="yyqns" }과 비슷하게 진행하면 된다. 예를 들어, 
...
$\Fun(I,\mathbb{R})$을 product set $\mathbb{R}^I$라 생각하면 [예시 6](#ex6){: data-lid="jthiz" }은 [예시 5](#ex5){: data-lid="7wfwt" }의 자연스러운 일반화로 볼 수도 있다. ([\[집합론\] §집합의 곱, ⁋정의 1](/ko/math/set_theory/product_of_sets#def1){: data-lid="aznt1" })
