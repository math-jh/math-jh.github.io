...
[명제 2](#prop2){: data-relation="required" }의 basis에 대한 Gram matrix는 대각성분이 $1$, $-1$, $0$인 diagonal matrix이다. 기저를 적절히 재배열하면, 이 diagonal matrix를 $1$이 $p$개, $-1$이 $q$개, $0$이 $r$개 나타나는 다음의 꼴
