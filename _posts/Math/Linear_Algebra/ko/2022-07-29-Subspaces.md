...
:::
::: 증명
귀납법을 이용하여 진행한다. $n=1$인 경우는 보일 것이 없으므로 $n=2$인 경우부터 생각하자. 이 경우 [명제 2](#prop2)에 의하여 $\alpha_1w_1,\alpha_2w_2$ 각각은 $W$의 원소이고 따라서 이들의 합 $\alpha_1w_1+\alpha_2w_2$ 또한 $W$의 원소이다.
