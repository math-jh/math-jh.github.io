...
The following proposition involves the same set-theoretic issue that was briefly mentioned after [\[Set Theory\] §Cardinals, ⁋Definition 1](/en/math/set_theory/cardinals#def1){: data-lid="n8s8x" data-relation="weak" }. Namely, it is uncertain whether <phrase>the collection of all $\mathbb{K}$-vector spaces</phrase> is actually a set, but we will pass over this without further comment.

::: Proposition 3
The relation $\cong$ of [Definition 1](#def1){: data-lid="k8v3a" data-relation="required" } is an equivalence relation.
:::
::: Proof
...
2. By the preceding [Lemma 2](#lem2){: data-lid="asvhj" data-relation="required" }, it is obvious that $\cong$ is symmetric.    
...
:::
::: Proof
[§Linear Maps, ⁋Example 14](/en/math/linear_algebra/linear_map#ex14){: data-lid="wroia" data-relation="required" } means that any $n$-dimensional $\mathbb{K}$-vector space $V$ satisfies $V\cong \mathbb{K}^n$. For another $n$-dimensional $\mathbb{K}$-vector space $W$ we also have $W\cong \mathbb{K}^n$, so from the fact that $\cong$ is an equivalence relation we know that $V\cong W$.
:::
...
:::
::: Proof
[§Linear Maps, ⁋Corollary 9](/en/math/linear_algebra/linear_map#cor9){: data-lid="yl7mg" data-relation="required" }.
:::
