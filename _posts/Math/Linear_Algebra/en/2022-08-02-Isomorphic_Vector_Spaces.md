...
2. By the preceding [Lemma 2](#lem2){: data-lid="asvhj" }, it is obvious that $\cong$ is symmetric.    
...
:::
::: Proof
[§Linear Maps, ⁋Example 14](/en/math/linear_algebra/linear_map#ex14){: data-lid="wroia" } means that any $n$-dimensional $\mathbb{K}$-vector space $V$ satisfies $V\cong \mathbb{K}^n$. For another $n$-dimensional $\mathbb{K}$-vector space $W$ we also have $W\cong \mathbb{K}^n$, so from the fact that $\cong$ is an equivalence relation we know that $V\cong W$.
:::
...
:::
::: Proof
[§Linear Maps, ⁋Corollary 9](/en/math/linear_algebra/linear_map#cor9){: data-lid="yl7mg" }.
:::
