...
respectively. By [§Fundamental Theorem of Linear Algebra](/en/math/linear_algebra/ftla){: data-lid="6p4pa" }, every linear map can be represented by a matrix once bases are chosen; hence we can represent $L^\ast$ as a matrix with respect to the bases $\mathcal{C}^\ast$ and $\mathcal{B}^\ast$.
...
:::
::: Proof
Both claims are immediate from [§Space of Linear Maps, ⁋Corollary 2](/en/math/linear_algebra/space_of_linear_maps#cor2){: data-lid="tuwru" }.
...
and [§Basis of a Vector Space, ⁋Lemma 3](/en/math/linear_algebra/basis#lem3){: data-lid="ymlyq" }, we see that $S^\perp$ is a subspace of $V^\ast$. Similarly, for any $T\subseteq V^\ast$, the set $T^\perp$ is a subspace of $V$.
...
:::
::: Proof
It suffices to take $U=V$ in [Proposition 8](#prop8){: data-lid="xy9rh" }. From the non-degeneracy of the canonical pairing $(-,-)$, we have $U^\perp=\{0\}$, yielding the desired result.
:::

In [Proposition 8](#prop8){: data-lid="dbwpx" }, we could instead start with $U\subseteq W^\ast$ rather than $U\subseteq V$. In that case we obtain the following proposition.
...
:::
::: Proof
It suffices to take $U=W^\ast$ in [Proposition 10](#prop10){: data-lid="jzl2f" }.
:::
