...
hold. Furthermore, the natural projection $p:V\rightarrow V/U$ (from [§Quotient Spaces, ⁋Definition 3](/en/math/linear_algebra/quotient_space#def3){: data-lid="3akqh" }) restricted to $U^\perp$ gives $p\vert_{U^\perp}:U^\perp\rightarrow V/U$, which is an isomorphism; thus $U^\perp$ realizes the quotient space $V/U$ canonically.
:::
::: Proof
