...
::: Proposition 5
Let $V$ be an $\mathbb{R}$-inner product space. If $\lVert -\rVert$ is the norm obtained from the inner product of $V$ via the formula in [Proposition 4](#prop4){: data-lid="dtbso" }, then the *parallelogram law*
...
then by [Proposition 5](#prop5){: data-lid="kb94f" } the identity
...
In fact, the converse of [Proposition 5](#prop5){: data-lid="7ic9l" } also holds: if $\lVert-\rVert$ satisfies the parallelogram law, then the form defined by
...
Since we know that $\ch\mathbb{R}=0$, from [§Bilinear Forms, ⁋Proposition 12](/en/math/linear_algebra/bilinear_form#prop12){: data-lid="67ck0" } we know that every $\mathbb{R}$-inner product space $V$ admits an orthogonal basis.
...
Let $V$ be an $\mathbb{R}$-inner product space and consider a linear operator $L:V\rightarrow V$ on it. In [§Dual Space](/en/math/linear_algebra/dual_space){: data-lid="c78fo" } we defined the dual $L^\ast:V^\ast\rightarrow V^\ast$ of $L$ as the linear operator satisfying

$$(Lv,f)=(v,L^\ast f)\qquad\text{for all $v\in V$, $f\in V^\ast$}$$

with respect to the canonical pairing $(-,-)$. On the other hand, if an inner product is given on $V$, then for any $0\neq v\in V$ we have $\langle v,v\rangle>0$, so the inner product is non-degenerate; therefore by [§Dual Space, ⁋Proposition 4](/en/math/linear_algebra/dual_space#prop4){: data-lid="ef1g9" },
