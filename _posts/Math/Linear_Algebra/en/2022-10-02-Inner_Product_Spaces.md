...
Since we know that $$\ch\mathbb{R}=0$$, from [§Bilinear Forms, ⁋Proposition 6](/en/math/linear_algebra/bilinear_form#prop6) we know that any $$\mathbb{R}$$-inner product space $$V$$ has an orthogonal basis.
