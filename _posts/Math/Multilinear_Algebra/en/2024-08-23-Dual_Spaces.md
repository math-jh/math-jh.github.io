...
date: 2024-08-23
weight: 4
translated_at: 2026-08-19T19:45:05+00:00
translation_source: kimi-cli
last_polished_at: 2026-08-19T19:45:05+00:00
---
...
::: Definition 3
The submodule of $M^\ast$ defined above is called the submodule orthogonal to $S$, and is denoted $S^\perp$.
:::
...
from [\[Algebraic Structures\] §Modules, ⁋Proposition 8](/en/math/algebraic_structures/modules#prop8){: data-lid="6v0z6" } is compatible with the right action of $A$. That is, $\Hom(u,A)$ is a right $A$-module homomorphism.
...
Moreover, for two $A$-linear maps $u,v:M \rightarrow N$ and arbitrary $\xi\in N^\ast$, $x\in M$, the equality $\xi((u+v)(x))=\xi(u(x))+\xi(v(x))$, together with the functoriality of $\Hom(-,A)$ and [\[Algebraic Structures\] §Modules, ⁋Proposition 8](/en/math/algebraic_structures/modules#prop8){: data-lid="uvnpc" }, yields the following proposition.
...
Suppose that the $A$-module $M$ has a basis $(e_i)_{i\in I}$. ([§Bases, ⁋Definition 1](/en/math/multilinear_algebra/basis_of_free_modules#def1){: data-lid="xtbc7" data-relation="weak" }) That is, there exists an isomorphism
