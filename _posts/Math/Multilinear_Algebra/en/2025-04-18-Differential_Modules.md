...
:::
::: Proof
First, by [Proposition 1](#prop1) we know that for every $(E, E)$-bimodule homomorphism $f: \mathfrak{I} \rightarrow M$, the composition $f \circ \delta_E$ is an $A$-derivation from $E$ to $M$.
