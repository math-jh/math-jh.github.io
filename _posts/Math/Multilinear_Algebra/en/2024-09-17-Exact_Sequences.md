...
For example, results for modules defined specifically over a field $$\mathbb{K}$$, that is, $$\mathbb{K}$$-vector spaces, were studied in [[Linear Algebra]](/en/linear_algebra/); choosing bases for $$\mathbb{K}$$-vector spaces or using them to represent linear maps as matrices are things that are hard to expect in general algebraic structures.

From this perspective, the main goal of the [[Multilinear Algebra]](/en/multilinear_algebra/) category may be said to generalize the results of [[Linear Algebra]](/en/linear_algebra/) as much as possible by replacing $$\mathbb{K}$$ with a general ring $$A$$. On the other hand, because the posts in that category were written with non-specialists or lower-year undergraduates in mind, they hardly used the language of [[Category Theory]](/en/category_theory/); thus, another goal is to recast the contents of [[Linear Algebra]](/en/linear_algebra/) in a modern language.
...
On the other hand, $$\bigoplus N_i$$ is generated by the union of the canonical inclusions $$N_i\hookrightarrow\bigoplus_{i\in I}N_i$$, and the image of this union under the above canonical morphism is $$\bigoplus N_i$$, so the following holds.
...
The following proposition helps us examine [Proposition 6](#def6) a little more intuitively when $$M$$ is the direct sum of two submodules $$N_1,N_2$$.
