...
:::
::: Proof
The proof of [[Linear Algebra] §Basis of a Vector Space, ⁋Lemma 3](/en/math/linear_algebra/basis#lem3) did not use the fact that $\mathbb{K}$ is a field, so we may use the same proof.
:::
...
:::
::: Proof
The proof is the same as that of [[Linear Algebra] §Basis of a Vector Space, ⁋Lemma 4](/en/math/linear_algebra/basis#lem4).
:::
