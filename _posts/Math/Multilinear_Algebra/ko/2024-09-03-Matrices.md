...
<ins id="def1">**정의 1**</ins> 임의의 집합 $$I, J$$에 대하여 $$I\times J$$ 행렬은 $$I\times J$$로 index가 주어진 $$A$$의 원소들의 family $$(x_{ij})_{(i,j)\in I\times J}$$를 의미하며, 이들의 모임을 $$\Mat_{I\times J}(A)$$로 적는다.
...
<ins id="def3">**정의 3**</ins> 임의의 $$I\times J$$ 행렬 $$X=(x_{ij})_{(i,j)\in I\times J}$$에 대하여, $$X$$의 *transpose<sub>전치행렬</sub>* $$X^t=(x^t_{ji})_{(j,i)\in J\times I}$$는 다음 식
