...
::: Definition 1
A *symplectic form* $\omega$ on a manifold $M$ is a differential $2$-form such that $\dd{\omega}=0$ and, for every $p\in M$, the map $\omega_p:T_pM\times T_pM\rightarrow \mathbb{R}$ is a linear symplectic form. We then call $(M,\omega)$ a *symplectic manifold*.
:::
