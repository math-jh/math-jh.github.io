...
::: 정의 9
$2n$차원 사교다양체 $(M,\omega)$의 부분다양체 $L\subseteq M$이 *Lagrangian submanifold<sub>라그랑지안 부분다양체</sub>*라는 것은, 포함사상 $\iota:L\hookrightarrow M$에 대하여 $\iota^\ast\omega=0$이고 $\dim L=n=\tfrac{1}{2}\dim M$인 것이다.
:::
...
::: 명제 11
다양체 $Q$ 위의 $1$-form $\alpha$에 대하여, 그 graph
