...
::: Theorem 7
Let $$A$$ be a Euclidean domain. Let $$a, b \in A$$ be nonzero elements, and let $$r_n$$ be the last nonzero remainder obtained by repeating the process of [Definition 2](#def2) until it can no longer continue. Then the following hold:
