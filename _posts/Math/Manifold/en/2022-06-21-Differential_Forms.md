...
Using [§Tangent and Cotangent Bundles, ⁋Example 5](/en/math/manifold/tangent_and_cotangent_bundles#ex5) and [§Tangent and Cotangent Bundles, ⁋Theorem 6](/en/math/manifold/tangent_and_cotangent_bundles#thm6), we can make the following definitions.

<div class="definition" markdown="1">

<ins id="def1">**Definition 1**</ins> For a manifold $$M$$, we call
...
Among the above [Definition 1](#def1), the elements of $$\Omega^\ast(M)$$ are of particular interest. By definition, any differential form $$\omega\in\Omega^\ast(M)$$ is a function $$M\rightarrow\bigwedge\nolimits^\ast(M)$$, and we write its values as
...
In particular, suppose $$\omega$$ is a $$k$$-form. To compute $$(F^\ast\omega)_p$$ at a point $$p\in M$$, we plug in $$k$$ vectors $$X_1(p),\ldots, X_k(p)$$ to obtain
...
<ins id="def3">**Definition 3**</ins> Consider a vector field $$X$$ given on a manifold $$M$$. Then $$\iota_X:\Omega^\ast(M) \rightarrow\Omega^\ast(M)$$ is the map that assigns to any $$k$$-form $$\omega$$ the $$(k-1)$$-form $$\iota_X\omega$$ defined by the formula
...
<ins id="prop4">**Proposition 4**</ins> For a manifold $$M$$ and any vector field $$X$$ given on it, the interior multiplication $$\iota_X$$ is an antiderivation of degree $$-1$$.
