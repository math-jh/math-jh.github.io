...
Let $$y\in P$$ be given, and choose a coordinate system $$(W,z^1,\ldots, z^m)$$ of $$M$$ containing $$\Phi(y)$$. Then by [§Submanifolds and the Inverse Function Theorem, ⁋Corollary 10](/en/math/manifold/submanifolds#cor10), restricting a suitable subset of $$\{z^k\circ\Phi\mid 1\leq k\leq m\}$$ to a suitable open neighborhood $$V$$ yields a coordinate system at the point $$y\in P$$.
