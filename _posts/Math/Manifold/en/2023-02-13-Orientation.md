...
being $$+1$$ or $$-1$$ determines the order. However, the above expression equals

$$x_3\cdot(x_1\times x_2)=\det[x_3\;x_1\;x_2]=\det[x_1\;x_2\;x_3]$$

so we can determine the order for a general basis that is not necessarily orthonormal by reading whether the value of the above determinant is positive or negative.
