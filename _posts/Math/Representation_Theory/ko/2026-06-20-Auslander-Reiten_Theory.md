...
이제 거의 모든 non-projective indecomposable $C$에 대하여 그것으로 끝나는 almost split sequence가 실제로 존재하고, 그 시작점이 정확히 $\tau C$임을 진술한다. 이 존재성 정리는 functorial 방법, 곧 module category 위의 functor들과 그들의 minimal projective resolution을 정밀하게 분석하여 증명되며, 그 전체 논증은 상당히 길다. 우리는 정리를 정확히 진술하고 완전한 증명은 문헌으로 미룬다.
