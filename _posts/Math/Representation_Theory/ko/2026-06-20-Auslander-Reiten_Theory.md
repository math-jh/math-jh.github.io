...
[명제 4](#prop4)에 의하여 이 almost split sequence는 $C$ (각각 $M$)에 의하여 isomorphism을 무시하면 유일하게 결정된다.
:::
::: 증명
