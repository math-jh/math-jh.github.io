...
::: 명제 4
$$A$$의 임의의 character $$\chi:A\rightarrow k$$에 대하여, $$\ker\chi$$는 codimension $$1$$인 ideal이며 따라서 maximal ideal이고, 유도되는 사상
...
::: 예시 16
유한 abelian group $$\mathbb{Z}/n$$의 group algebra를 $$k=\mathbb{C}$$ 위에서 생각하자. 생성원 $$\sigma$$가 만족하는 유일한 관계는 $$\sigma^n=1$$이므로
