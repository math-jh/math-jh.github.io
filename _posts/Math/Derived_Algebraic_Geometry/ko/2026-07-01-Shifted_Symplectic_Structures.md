...
::: 정의 4
$$k$$ 위의 유한차원 vector space $$V$$에 대하여, *alternating $$2$$-형식*이란 원소 $$\omega\in\wedge^2V^\ast$$을 뜻하며, 이는 $$\omega(v,v)=0$$을 만족하는 쌍선형형식과 같다. 그 *flat 사상*을
...
::: 정의 5
Derived stack $$X$$ 위의 *$$n$$-shifted symplectic 구조<sub>$$n$$-shifted symplectic structure</sub>*란, degree $$n$$의 닫힌 $$2$$-형식 $$\omega\in\mathcal{A}^{2,\mathrm{cl}}(X,n)$$으로서, 그 밑에 깔린 $$2$$-형식 $$\omega_0:\mathcal{O}_X\rightarrow(\wedge^2L_X)[n]$$이 유도하는 사상
...
::: 예시 6 ($$0$$-shifted: 고전적 symplectic 다양체)
...
$$G$$을 $$k$$ 위의 reductive algebraic group, $$\mathfrak{g}=\Lie(G)$$을 그 Lie algebra라 하자. 분류 stack $$\mathbf{B}G$$은 geometric derived stack이고 ([§Derived scheme과 derived stack, ⁋예시 9](/ko/math/derived_algebraic_geometry/derived_schemes#ex9)), 그 atlas $$u:\Spec k\rightarrow\mathbf{B}G$$은 $$G$$-torsor로서 상대차원 $$\dim G$$의 매끄러운 사상이므로 상대 여접 복합체는 fiber $$G$$의 항등원 여접공간이 degree $$0$$에 놓인 $$L_{\Spec k/\mathbf{B}G}\simeq\mathfrak{g}^\ast$$이다. 추이 삼각형 ([§Derived scheme과 derived stack, ⁋명제 11](/ko/math/derived_algebraic_geometry/derived_schemes#prop11)) $$u^\ast L_{\mathbf{B}G}\rightarrow L_{\Spec k}\rightarrow L_{\Spec k/\mathbf{B}G}$$에서 $$L_{\Spec k}=0$$이므로 $$u^\ast L_{\mathbf{B}G}\simeq L_{\Spec k/\mathbf{B}G}[-1]=\mathfrak{g}^\ast[-1]$$, 곧 여접 복합체는 $$L_{\mathbf{B}G}=\mathfrak{g}^\ast[-1]$$이고 그 쌍대인 접복합체는 $$T_{\mathbf{B}G}=\mathfrak{g}[1]$$이다. Odd degree 대상의 exterior power에 대한 Koszul 부호 규칙에 의하여
...
::: 정리 8
$$U$$을 매끄러운 $$k$$-스킴, $$f:U\rightarrow\mathbb{A}^1$$을 함수라 하자. Derived critical locus $$\Crit(f)$$은 canonically $$(-1)$$-shifted symplectic이다. 그 밑에 깔린 $$2$$-형식이 유도하는 nondegeneracy 동치
...
$$(X,\omega)$$을 $$(-1)$$-shifted symplectic derived scheme이라 하자. 그러면 $$X$$은 Zariski 국소적으로 어떤 매끄러운 스킴 $$U$$ 위의 함수 $$f:U\rightarrow\mathbb{A}^1$$의 derived critical locus
...
::: 정의 10
$$(X,\omega)$$을 $$n$$-shifted symplectic derived stack, $$g:L\rightarrow X$$을 사상이라 하자. $$L$$ 위의 *isotropic 구조*란 당김 $$g^\ast\omega\in\mathcal{A}^{2,\mathrm{cl}}(L,n)$$을 $$0$$으로 이어 주는 homotopy $$\gamma$$, 곧 닫힌 $$2$$-형식으로서의 nullhomotopy $$\gamma:g^\ast\omega\sim0$$이다. 이 자료는 상대 접복합체 위의 사상
...
$$(X,\omega)$$을 $$n$$-shifted symplectic derived stack, $$g_1:L_1\rightarrow X$$과 $$g_2:L_2\rightarrow X$$을 Lagrangian 사상이라 하자. 그러면 유도 올곱
...
$$F$$을 *$$d$$-orientation*을 갖춘 derived stack이라 하자. 곧 $$F$$은 $$\mathcal{O}$$-compact이고, 대역 절단 위에 degree $$-d$$의 비축퇴 적분 사상
...
$$G$$을 semisimple algebraic group이라 하면 $$\mathbf{B}G$$은 [예시 7](#ex7)에 의하여 $$2$$-shifted symplectic이다. Compact oriented $$d$$-다양체 $$M$$의 Betti stack을 $$M_B$$이라 하면, mapping stack
