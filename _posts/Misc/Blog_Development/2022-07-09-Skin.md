...
관련 커밋: [링크](https://github.com/math-jh/math-jh.github.io/commit/5516c78a5b71a0c44baff183d0f7a85dca772fdb)
{: .notice--info}
...
.masthead {
  ...
  ...
```
{: data-filename="_sass/minimal-mistakes/_masthead.scss"}
...
```
{: data-filename="_sass/minimal-mistakes/_search.scss"}
