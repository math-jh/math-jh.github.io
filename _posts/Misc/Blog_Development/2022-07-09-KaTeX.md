...
관련 커밋: [링크](https://github.com/math-jh/math-jh.github.io/commit/8115a530145a1759b60933ee26828dc395fc4751)
{: .notice--info}
...
다만, 나는 폰트를 설치할 때와 마찬가지로 사이트에 $\KaTeX$를 직접 넣기로 했다. 위의 방법처럼 CDN을 통해 $\KaTeX$을 설치했다면 맨 밑에 [기타 설정](#기타-설정){: data-relation="weak" }만 보면 충분하다.
