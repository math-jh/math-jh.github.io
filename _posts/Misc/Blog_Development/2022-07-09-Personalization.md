...
1. Google의 머터리얼 디자인 아이콘 [repository](https://github.com/marella/material-icons)에서 `material-icons-sharp.woff`와 `woff2` 파일을 다운받아, [블로그 폰트 추가](/ko/misc/blog_development/fonts){: data-relation="required" }에서 했던 것처럼 폰트를 추가해준다.
