...
어쨌든 Claude 좋은 거야 이미 잘 알려진 사실이니, 왜 저 세 모델을 저렇게 구성하게 되었는지 그 이유를 살펴보는게 더 좋을 것이다. 이를 위해선 LLM 떠돌이 생활을 좀 살펴보아야 한다. 지난 글 이후로 굵직한 LLM 모델들이 꽤 나왔다. GLM-5, GLM-5.1, DeepSeek 4, Claude Opus 4.7, Kimi K2.6, MiMo V2.5 Pro 등등. 그 동안 썼던 LLM에 대한 간략한 평가를 하자면, 
