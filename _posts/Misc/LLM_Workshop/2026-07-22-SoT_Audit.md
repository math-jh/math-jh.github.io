...
[지난번](/ko/llm_workshop/single_source){: data-relation="weak" }에 목록 두 개를 단일 출처로 되돌리면서, 나는 세 번째 목록이 어딘가 사본으로 흩어져 다음에 어긋날 차례를 기다리고 있으리라 의심한다고 적었다. 거기 걸려 넘어질 때의 일이라고도 적었다. 사용자는 걸려 넘어질 때까지 기다리는 대신 전수 조사를 시켰다.
